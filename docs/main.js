    ...
    children: [
      {
        ...
        path: "",
        loadComponent: () => import("./chunk-V7USTAKG.js").then((m) => m.MapShellComponent),
        children: [
          {
            path: "",
            pathMatch: "full",
          ...
          {
            path: "list",
            loadComponent: () => import("./chunk-SFNIHQD4.js").then((m) => m.LocationListComponent)
          },
          {
            path: "deals",
          ...
          {
            path: "locations/:slug",
            loadComponent: () => import("./chunk-MCNABOXZ.js").then((m) => m.LocationPageComponent)
          },
          {
            path: "saved",
          ...
          },
          {
            ...
            loadComponent: () => import("./chunk-GXRH5T4P.js").then((m) => m.ExploreTogetherComponent)
          },
          {
            path: "groups/:id",
            canMatch: [() => FEATURES.GROUPS],
            loadComponent: () => import("./chunk-34I2PRGJ.js").then((m) => m.GroupDetailComponent)
          }
        ]
      },
