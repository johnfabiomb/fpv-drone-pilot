...
var mapRoutes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-UTDZ7J5E.js").then((m) => m.MapRootComponent),
    children: [
      {
        path: "",
        pathMatch: "full",
      ...
      },
      {
        ...
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-I22BLUAV.js").then((m) => m.MapShellComponent),
            children: [
              {
                path: "",
                pathMatch: "full",
...
//# sourceMappingURL=chunk-YQ2J7XTB.js.map
