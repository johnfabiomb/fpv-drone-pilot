...
// src/app/features/map/deals/deals.component.ts
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DealsComponent, selectors: [["app-deals"]], decls: 6, vars: 1, consts: [["title", "Local Deals", 3, "closeRequested", "dragStart", "dragMove", "dragEnd", "bodyDragStart", "bodyDragMove", "bodyDragEnd"], [1, "deals-list"], [1, "deals-intro"], [1, "deals-intro__text"], [3, "provider", "selected", 4, "ngFor", "ngForOf"], [3, "selected", "provider"]], template: function DealsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(4, "Deals from local partners I've personally connected with \u2014 tap a card or a map pin to grab the offer.");
        \u0275\u0275elementEnd()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DealsComponent, { className: "DealsComponent", filePath: "src/app/features/map/deals/deals.component.ts", lineNumber: 21 });
})();
export {
  DealsComponent
};
//# sourceMappingURL=chunk-3EVTGUUB.js.map
