...
var createMap = (center, zoom, target) => new Map_default2({
  target,
  controls: defaults({ rotate: true, rotateOptions: { autoHide: false, label: makeCompassLabel() } }),
  layers: [
    new Tile_default3({
...
function MapComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 5);
    \u0275\u0275element(2, "circle", 6)(3, "line", 7)(4, "line", 8);
    \u0275\u0275elementEnd();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MapComponent, selectors: [["app-map"]], hostVars: 2, hostBindings: function MapComponent_HostBindings(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275element(2, "i", 2);
        \u0275\u0275elementEnd();
        \u0275\u0275template(3, MapComponent_div_3_Template, 6, 0, "div", 3);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_0_0;
        \u0275\u0275advance();
        \u0275\u0275classProp("has-gps", (tmp_0_0 = ctx.tracker == null ? null : ctx.tracker.hasGps) !== null && tmp_0_0 !== void 0 ? tmp_0_0 : false);
        \u0275\u0275advance(2);
...
//# sourceMappingURL=chunk-QDSAGQEM.js.map
