...
function GroupsSectionComponent_ng_container_1_div_7_div_18_ul_2_li_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 63);
    \u0275\u0275listener("click", function GroupsSectionComponent_ng_container_1_div_7_div_18_ul_2_li_1_Template_li_click_0_listener() {
...
function GroupsSectionComponent_ng_container_1_div_7_div_18_ul_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 61);
    \u0275\u0275template(1, GroupsSectionComponent_ng_container_1_div_7_div_18_ul_2_li_1_Template, 2, 1, "li", 62);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function GroupsSectionComponent_ng_container_1_div_7_div_18_span_3_Template(rf, ctx) {
  if (rf & 1) {
...
function GroupsSectionComponent_ng_container_1_div_7_div_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function GroupsSectionComponent_ng_container_1_div_7_div_18_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(3);
      \u0275\u0275twoWayBindingSet(ctx_r0.formSpotSearch, $event) || (ctx_r0.formSpotSearch = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function GroupsSectionComponent_ng_container_1_div_7_div_18_Template_input_input_1_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.onSpotSearchInput());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(2, GroupsSectionComponent_ng_container_1_div_7_div_18_ul_2_Template, 2, 1, "ul", 59)(3, GroupsSectionComponent_ng_container_1_div_7_div_18_span_3_Template, 4, 1, "span", 60);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function GroupsSectionComponent_ng_container_1_div_7_div_55_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 67)(1, "span", 68);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 24);
    \u0275\u0275element(3, "path", 55)(4, "circle", 56);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5, " Is this the right spot? ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "div", 69)(7, "button", 70);
    \u0275\u0275listener("click", function GroupsSectionComponent_ng_container_1_div_7_div_55_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r0 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function GroupsSectionComponent_ng_container_1_div_7_div_55_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r0 = \u0275\u0275nextContext(3);
...
function GroupsSectionComponent_ng_container_1_div_7_div_56_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 72)(1, "button", 73);
    \u0275\u0275listener("click", function GroupsSectionComponent_ng_container_1_div_7_div_56_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r0 = \u0275\u0275nextContext(3);
...
function GroupsSectionComponent_ng_container_1_div_7_div_57_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function GroupsSectionComponent_ng_container_1_div_7_div_57_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(3);
...
function GroupsSectionComponent_ng_container_1_div_7_p_58_Template(rf, ctx) {
  if (rf & 1) {
...
function GroupsSectionComponent_ng_container_1_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(16, "(optional)");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(17, GroupsSectionComponent_ng_container_1_div_7_div_17_Template, 5, 1, "div", 37)(18, GroupsSectionComponent_ng_container_1_div_7_div_18_Template, 4, 3, "div", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div", 39)(20, "div", 34)(21, "label");
    \u0275\u0275text(22, "Date");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "div", 34)(25, "label");
    \u0275\u0275text(26, "Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "input", 41);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(28, "div", 34)(29, "label");
    \u0275\u0275text(30, "Difficulty");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "div", 42)(32, "span", 43);
    ...
    \u0275\u0275text(52, "Meeting point ");
    \u0275\u0275elementStart(53, "span", 36);
    \u0275\u0275text(54, "(optional)");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(55, GroupsSectionComponent_ng_container_1_div_7_div_55_Template, 11, 0, "div", 46)(56, GroupsSectionComponent_ng_container_1_div_7_div_56_Template, 6, 0, "div", 47)(57, GroupsSectionComponent_ng_container_1_div_7_div_57_Template, 6, 0, "div", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275template(58, GroupsSectionComponent_ng_container_1_div_7_p_58_Template, 2, 1, "p", 49);
    \u0275\u0275elementStart(59, "div", 50)(60, "button", 51);
    \u0275\u0275listener("click", function GroupsSectionComponent_ng_container_1_div_7_Template_button_click_60_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.cancelCreate());
    });
    \u0275\u0275text(61, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "button", 52);
    \u0275\u0275listener("click", function GroupsSectionComponent_ng_container_1_div_7_Template_button_click_62_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function GroupsSectionComponent_ng_container_1_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, GroupsSectionComponent_ng_container_1_div_9_app_group_card_3_Template, 1, 1, "app-group-card", 81);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function GroupsSectionComponent_ng_container_1_button_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 83);
    \u0275\u0275listener("click", function GroupsSectionComponent_ng_container_1_button_10_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.authService.openLoginModal());
    });
    ...
    \u0275\u0275elementStart(5, "svg", 85);
    \u0275\u0275element(6, "polyline", 86);
    \u0275\u0275elementEnd()();
  }
}
function GroupsSectionComponent_ng_container_1_div_11_p_3_Template(rf, ctx) {
  if (rf & 1) {
...
function GroupsSectionComponent_ng_container_1_div_11_p_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 92);
...
function GroupsSectionComponent_ng_container_1_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "\u{1F97E}");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, GroupsSectionComponent_ng_container_1_div_11_p_3_Template, 2, 0, "p", 89)(4, GroupsSectionComponent_ng_container_1_div_11_p_4_Template, 2, 0, "p", 89);
    \u0275\u0275elementStart(5, "p", 90);
    \u0275\u0275text(6, "Be the first to organise one!");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 91);
    \u0275\u0275listener("click", function GroupsSectionComponent_ng_container_1_div_11_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openCreateForm());
    });
    ...
    \u0275\u0275element(9, "line", 21)(10, "line", 22);
    \u0275\u0275elementEnd();
...
function GroupsSectionComponent_ng_container_1_div_12_p_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 92);
    \u0275\u0275text(1, "No upcoming groups yet");
    \u0275\u0275elementEnd();
...
function GroupsSectionComponent_ng_container_1_div_12_p_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 92);
    \u0275\u0275text(1, "No groups at this spot yet");
    \u0275\u0275elementEnd();
...
function GroupsSectionComponent_ng_container_1_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 87)(1, "div", 88);
    \u0275\u0275text(2, "\u{1F97E}");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, GroupsSectionComponent_ng_container_1_div_12_p_3_Template, 2, 0, "p", 89)(4, GroupsSectionComponent_ng_container_1_div_12_p_4_Template, 2, 0, "p", 89);
    \u0275\u0275elementStart(5, "p", 90);
    \u0275\u0275text(6, "Sign in to be the first to organise one!");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 93);
    \u0275\u0275listener("click", function GroupsSectionComponent_ng_container_1_div_12_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.authService.openLoginModal());
    });
...
function GroupsSectionComponent_ng_container_1_ng_container_13_div_1_div_8_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 104);
    \u0275\u0275element(1, "app-group-card", 82);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const g_r16 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("group", g_r16);
  }
}
function GroupsSectionComponent_ng_container_1_ng_container_13_div_1_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 102);
    \u0275\u0275template(1, GroupsSectionComponent_ng_container_1_ng_container_13_div_1_div_8_div_1_Template, 2, 1, "div", 103);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(4);
...
function GroupsSectionComponent_ng_container_1_ng_container_13_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 95)(1, "button", 96);
    \u0275\u0275listener("click", function GroupsSectionComponent_ng_container_1_ng_container_13_div_1_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r15);
      const ctx_r0 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275element(3, "circle", 97)(4, "polyline", 98);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5);
    \u0275\u0275elementStart(6, "svg", 99);
    \u0275\u0275element(7, "polyline", 100);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, GroupsSectionComponent_ng_container_1_ng_container_13_div_1_div_8_Template, 2, 1, "div", 101);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function GroupsSectionComponent_ng_container_1_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, GroupsSectionComponent_ng_container_1_ng_container_13_div_1_Template, 9, 5, "div", 94);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function GroupsSectionComponent_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, GroupsSectionComponent_ng_container_1_div_7_Template, 64, 20, "div", 13)(8, GroupsSectionComponent_ng_container_1_div_8_Template, 4, 0, "div", 14)(9, GroupsSectionComponent_ng_container_1_div_9_Template, 4, 3, "div", 15)(10, GroupsSectionComponent_ng_container_1_button_10_Template, 7, 0, "button", 16)(11, GroupsSectionComponent_ng_container_1_div_11_Template, 12, 2, "div", 17)(12, GroupsSectionComponent_ng_container_1_div_12_Template, 9, 2, "div", 17)(13, GroupsSectionComponent_ng_container_1_ng_container_13_Template, 2, 1, "ng-container", 1);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.isLoading && ctx_r0.groups.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.authService.isLoggedIn() && !ctx_r0.isLoading && ctx_r0.groups.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.isLoading && ctx_r0.groups.length === 0 && !ctx_r0.showCreateForm() && ctx_r0.authService.isLoggedIn());
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.isLoading && ctx_r0.groups.length === 0 && !ctx_r0.authService.isLoggedIn());
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.authService.isLoggedIn());
  }
}
var GroupsSectionComponent = class _GroupsSectionComponent {
  ...
  onSpotSearchInput() {
    ...
    this.spotResults.set(this.allSpots.filter((s) => normalizeForSearch(s.title).includes(q)).slice(0, 6));
  }
  selectSpot(spot) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GroupsSectionComponent, { className: "GroupsSectionComponent", filePath: "src/app/components/groups-section/groups-section.component.ts", lineNumber: 46 });
})();

export {
  GroupsSectionComponent
};
//# sourceMappingURL=chunk-EYEIJUSS.js.map
