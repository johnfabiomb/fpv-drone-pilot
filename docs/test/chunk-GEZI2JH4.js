...
var mapRoutes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-OJ6RQCJW.js").then((m) => m.MapRootComponent),
    children: [
      {
        path: "",
        pathMatch: "full",
      ...
      },
      {
        ...
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-V6CIPGS6.js").then((m) => m.MapShellComponent),
            children: [
              {
                path: "",
                pathMatch: "full",
                loadComponent: () => import("./chunk-TXPWLURN.js").then((mod) => mod.MapExploreComponent)
              },
              {
                path: "list",
              ...
              {
                path: "events",
                loadComponent: () => import("./chunk-2WWD6FMO.js").then((m) => m.EventsComponent)
              },
              {
                path: "providers/:id",
...
//# sourceMappingURL=chunk-GEZI2JH4.js.map
