...
// src/app/platform/trend/trend.component.ts
function TrendComponent_button_39__svg_svg_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 32);
    \u0275\u0275element(1, "line", 33)(2, "polyline", 34);
    \u0275\u0275elementEnd();
  }
}
function TrendComponent_button_39__svg_svg_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 35);
    \u0275\u0275element(1, "circle", 36)(2, "line", 37)(3, "line", 38);
    \u0275\u0275elementEnd();
  }
}
function TrendComponent_button_39_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 26);
    \u0275\u0275listener("click", function TrendComponent_button_39_Template_button_click_0_listener() {
    ...
    \u0275\u0275template(6, TrendComponent_button_39__svg_svg_6_Template, 3, 0, "svg", 30)(7, TrendComponent_button_39__svg_svg_7_Template, 4, 0, "svg", 31);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function TrendComponent_div_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39)(1, "span", 40);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 41);
    \u0275\u0275element(4, "span", 42)(5, "span", 43);
    \u0275\u0275elementEnd();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TrendComponent, selectors: [["app-trend"]], decls: 48, vars: 6, consts: [[1, "trend-page"], [1, "trend-header"], [1, "trend-badge"], [1, "trend-title"], [1, "trend-sub"], [1, "progress-wrap"], [1, "progress-bar"], [1, "progress-fill"], [1, "progress-label"], ["routerLink", "/malta", 1, "map-btn"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.2", "stroke-linecap", "round", "stroke-linejoin", "round"], ["points", "3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"], ["x1", "9", "y1", "3", "x2", "9", "y2", "18"], ["x1", "15", "y1", "6", "x2", "15", "y2", "21"], [1, "trend-intro"], [1, "trend-intro-text"], [1, "trend-chips"], [1, "trend-chip"], [1, "trend-list"], ["class", "trend-card", 3, "no-map", "click", 4, "ngFor", "ngForOf"], ["class", "trend-card trend-card--locked", 4, "ngFor", "ngForOf"], [1, "trend-footer"], ["href", "https://www.instagram.com/johnfabiomb/", "target", "_blank", "rel", "noopener", 1, "trend-ig"], ["width", "15", "height", "15", "viewBox", "0 0 24 24", "fill", "currentColor"], ["d", "M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"], [1, "trend-footer-copy"], [1, "trend-card", 3, "click"], [1, "card-num"], [1, "card-name"], [1, "card-arrow"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.5", "stroke-linecap", "round", "stroke-linejoin", "round", 4, "ngIf"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 4, "ngIf"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.5", "stroke-linecap", "round", "stroke-linejoin", "round"], ["x1", "5", "y1", "12", "x2", "19", "y2", "12"], ["points", "12 5 19 12 12 19"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"], ["cx", "12", "cy", "12", "r", "10"], ["x1", "12", "y1", "8", "x2", "12", "y2", "12"], ["x1", "12", "y1", "16", "x2", "12.01", "y2", "16"], [1, "trend-card", "trend-card--locked"], [1, "card-num", "card-num--locked"], [1, "card-name", "card-name--locked"], [1, "redacted"], [1, "redacted", "redacted--sm"], [1, "card-lock"], ["width", "13", "height", "13", "viewBox", "0 0 24 24", "fill", "currentColor"], ["d", "M18 10h-1V7A5 5 0 0 0 7 7v3H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2zM9 7a3 3 0 0 1 6 0v3H9V7zm9 13H6v-8h12v8zm-6-3a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"]], template: function TrendComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(39, TrendComponent_button_39_Template, 8, 6, "button", 19)(40, TrendComponent_div_40_Template, 9, 1, "div", 20);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(41, "footer", 21)(42, "a", 22);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(43, "svg", 23);
        \u0275\u0275element(44, "path", 24);
        \u0275\u0275elementEnd();
        \u0275\u0275text(45, " @johnfabiomb ");
        \u0275\u0275elementEnd();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(46, "span", 25);
        \u0275\u0275text(47, "Explore Malta \xB7 Interactive Map");
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(15);
...
//# sourceMappingURL=chunk-T6WYF6OM.js.map
