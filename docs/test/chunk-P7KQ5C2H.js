...
function LineItemsEditorComponent_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 1)(1, "textarea", 6);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r2.items().length === 1);
  }
}
function LineItemsEditorComponent_Conditional_3_Conditional_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
...
function LineItemsEditorComponent_Conditional_3_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "optgroup", 12);
    \u0275\u0275repeaterCreate(1, LineItemsEditorComponent_Conditional_3_Conditional_6_For_2_Template, 2, 2, "option", 15, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LineItemsEditorComponent_Conditional_3_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 16)(1, "input", 17);
    \u0275\u0275twoWayListener("ngModelChange", function LineItemsEditorComponent_Conditional_3_Conditional_7_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function LineItemsEditorComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 2)(1, "select", 9);
    \u0275\u0275twoWayListener("ngModelChange", function LineItemsEditorComponent_Conditional_3_Template_select_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.pickId, $event) || (ctx_r2.pickId = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(2, "option", 10);
    \u0275\u0275text(3, "What are you charging?");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "option", 11);
    \u0275\u0275text(5, "Custom charge");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, LineItemsEditorComponent_Conditional_3_Conditional_6_Template, 3, 0, "optgroup", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, LineItemsEditorComponent_Conditional_3_Conditional_7_Template, 7, 7);
    \u0275\u0275elementStart(8, "button", 13);
    \u0275\u0275listener("click", function LineItemsEditorComponent_Conditional_3_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function LineItemsEditorComponent_Conditional_3_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
...
function LineItemsEditorComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LineItemsEditorComponent_Conditional_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
...
var LineItemsEditorComponent = class _LineItemsEditorComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LineItemsEditorComponent, selectors: [["app-line-items-editor"]], inputs: { items: [1, "items"], currency: [1, "currency"], services: [1, "services"] }, outputs: { items: "itemsChange" }, decls: 11, vars: 7, consts: [[1, "items"], [1, "item"], [1, "add-row"], ["type", "button", 1, "add"], [1, "total"], [1, "total__value"], ["rows", "1", "placeholder", "Description", 1, "item__desc", 3, "ngModelChange", "ngModel"], ["type", "number", "min", "0", "step", "1", "inputmode", "decimal", 1, "item__amount", 3, "ngModelChange", "ngModel"], ["type", "button", "aria-label", "Remove line", 1, "item__remove", 3, "click", "disabled"], ["name", "pickId", 1, "add-row__what", 3, "ngModelChange", "ngModel"], ["value", ""], ["value", "custom"], ["label", "Services"], ["type", "button", 1, "add-row__add", 3, "click", "disabled"], ["type", "button", 1, "add-row__cancel", 3, "click"], [3, "value"], [1, "add-row__hours"], ["type", "number", "min", "1", "step", "1", "name", "pickHours", "aria-label", "Hours", 3, "ngModelChange", "ngModel"], [1, "add-row__unit"], [1, "add-row__price"], ["type", "button", 1, "add", 3, "click"]], template: function LineItemsEditorComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275repeaterCreate(1, LineItemsEditorComponent_For_2_Template, 5, 3, "div", 1, \u0275\u0275repeaterTrackByIndex);
        \u0275\u0275elementEnd();
        \u0275\u0275template(3, LineItemsEditorComponent_Conditional_3_Template, 12, 4, "div", 2)(4, LineItemsEditorComponent_Conditional_4_Template, 2, 0, "button", 3);
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.picking() ? 3 : 4);
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(10, 2, ctx.total(), ctx.currency(), "symbol", "1.2-2"));
      }
...
//# sourceMappingURL=chunk-P7KQ5C2H.js.map
