...
// src/app/core/models/timestamp.ts
...
// src/app/core/services/groups.service.ts
var GroupsService = class _GroupsService {
  ...
  joinGroup(groupId) {
    return __async(this, null, function* () {
      ...
      if (!user)
        throw new Error("Not authenticated");
      const { error } = yield supabase.rpc("join_group", { p_group_id: groupId });
      if (error) {
...
//# sourceMappingURL=chunk-WFROJCO2.js.map
