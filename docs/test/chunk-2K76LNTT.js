...
} from "./chunk-SW7OWG24.js";
import {
  ShareButtonComponent
} from "./chunk-REU4UYUY.js";
import {
  GroupsSectionComponent
} from "./chunk-WZKZWRTW.js";
import {
  ConfirmPopupComponent
} from "./chunk-UPKOCX44.js";
import {
  AnalyticsService
} from "./chunk-QDSPT2EL.js";
import {
  PanelShellComponent
} from "./chunk-33XMGGIA.js";
import "./chunk-EW5LUM7T.js";
import {
  ProviderCardComponent
} from "./chunk-R6QWHCFK.js";
import {
  getProvidersNearLocation,
  haversineKm,
  haversineM
} from "./chunk-T4Z37JQY.js";
import {
  fmtStatCount,
  getIsland,
  locationPublicStats
...
function LocationDetailComponent_div_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "path", 63)(4, "circle", 64)(5, "path", 65)(6, "path", 66);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(9, "New");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(10, "app-groups-section", 68);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_div_25_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "img", 74);
    \u0275\u0275elementStart(2, "div", 75)(3, "span", 76);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, LocationDetailComponent_div_25_div_4_span_5_Template, 2, 1, "span", 77);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "span", 78);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(8, "svg", 79);
    \u0275\u0275element(9, "polyline", 80);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function LocationDetailComponent_div_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(4, LocationDetailComponent_div_25_div_4_Template, 10, 5, "div", 72);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LocationPageComponent, { className: "LocationPageComponent", filePath: "src/app/features/locations/location-page/location-page.component.ts", lineNumber: 164 });
})();
export {
  LocationPageComponent
};
//# sourceMappingURL=chunk-2K76LNTT.js.map
