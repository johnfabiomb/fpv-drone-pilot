...
var providers = [
  ...
  },
  {
    ...
    experiences: [
      ...
      },
      {
        ...
        spots: [
          { lat: 36.003082367829464, lon: 14.347934659739774, label: "Blue Lagoon, Comino", nearLocationIds: [52] }
        ]
      },
      {
  ...
  },
  {
    ...
    mapLabel: "Deal",
    highlights: [
      "Guided kayak tours from Xlendi Bay, Gozo",
      "Sea caves only reachable by kayak",
      "Crystal-clear turquoise waters & coastal adventures",
      "Great for beginners, couples, families & groups",
      "Two swim stops inside the caves",
      "Life jackets, snorkel masks & dry bags provided"
    ],
    experiences: [
      {
        id: "gozo-kayak-sea-caves",
        providerId: "gozo-kayak-tours",
        ...
        spots: [
          {
            lat: 36.02903985350436,
            lon: 14.210555103124504,
            label: "Gozo Kayak Tours \xB7 Xlendi",
            nearLocationIds: [
              77,
              58,
              50
