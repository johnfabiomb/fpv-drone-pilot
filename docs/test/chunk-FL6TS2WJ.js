...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProviderDetailComponent, { className: "ProviderDetailComponent", filePath: "src/app/map/features/providers/provider-detail/provider-detail.component.ts", lineNumber: 18 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProviderPageComponent, { className: "ProviderPageComponent", filePath: "src/app/map/features/providers/provider-page/provider-page.component.ts", lineNumber: 52 });
})();
export {
  ProviderPageComponent
};
//# sourceMappingURL=chunk-FL6TS2WJ.js.map
