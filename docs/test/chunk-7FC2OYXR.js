...
function BookingDetailComponent_Conditional_3_Conditional_0_Conditional_43_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 47)(1, "span", 49);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function BookingDetailComponent_Conditional_3_Conditional_0_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "ul", 46);
    \u0275\u0275repeaterCreate(7, BookingDetailComponent_Conditional_3_Conditional_0_Conditional_43_For_8_Template, 6, 7, "li", 47, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
...
function BookingDetailComponent_Conditional_3_Conditional_0_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, BookingDetailComponent_Conditional_3_Conditional_0_Conditional_45_For_5_Template, 4, 8, "span", 51, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function BookingDetailComponent_Conditional_3_Conditional_0_Conditional_71_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 53)(1, "div", 54);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "currency");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, BookingDetailComponent_Conditional_3_Conditional_0_Conditional_71_For_2_Conditional_7_Template, 2, 1, "span", 57)(8, BookingDetailComponent_Conditional_3_Conditional_0_Conditional_71_For_2_Conditional_8_Template, 2, 0, "span", 58)(9, BookingDetailComponent_Conditional_3_Conditional_0_Conditional_71_For_2_Conditional_9_Template, 2, 0, "span", 59);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 60);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, BookingDetailComponent_Conditional_3_Conditional_0_Conditional_71_For_2_Conditional_13_Template, 2, 0, "button", 61);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_20_0;
...
function BookingDetailComponent_Conditional_3_Conditional_0_Conditional_71_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, BookingDetailComponent_Conditional_3_Conditional_0_Conditional_71_For_2_Template, 14, 17, "li", 52, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function BookingDetailComponent_Conditional_3_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(63, "div", 20)(64, "div", 21)(65, "div", 27)(66, "h2", 28);
    \u0275\u0275text(67, "Payments");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "span", 29);
    \u0275\u0275text(69);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(70, BookingDetailComponent_Conditional_3_Conditional_0_Conditional_70_Template, 2, 0, "p", 30)(71, BookingDetailComponent_Conditional_3_Conditional_0_Conditional_71_Template, 3, 0, "ul", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(72, "div", 21)(73, "div", 27)(74, "h2", 28);
    \u0275\u0275text(75, "Record a payment");
    \u0275\u0275elementEnd();
    \u0275\u0275template(76, BookingDetailComponent_Conditional_3_Conditional_0_Conditional_76_Template, 3, 6, "button", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "form", 33);
    ...
    \u0275\u0275elementStart(78, "div", 34)(79, "div", 35)(80, "label");
    \u0275\u0275text(81, "Amount (\u20AC)");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(87, BookingDetailComponent_Conditional_3_Conditional_0_For_88_Template, 2, 2, "option", 38, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(89, "div", 35)(90, "label");
    \u0275\u0275text(91, "Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(92, "input", 39);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(99, "div", 43)(100, "button", 44);
    \u0275\u0275text(101);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
...
function BookingDetailComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, BookingDetailComponent_Conditional_3_Conditional_0_Template, 102, 50);
  }
  if (rf & 2) {
    let tmp_1_0;
...
//# sourceMappingURL=chunk-7FC2OYXR.js.map
