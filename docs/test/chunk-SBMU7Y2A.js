...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TopPlacesComponent, { className: "TopPlacesComponent", filePath: "src/app/map/pages/top-places/top-places.component.ts", lineNumber: 48 });
})();
export {
  TopPlacesComponent
};
//# sourceMappingURL=chunk-SBMU7Y2A.js.map
