...
function FooterComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(36, " John Monta\xF1o - FPV Drone Pilot ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["app-footer"]], hostBindings: function FooterComponent_HostBindings(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275text(12, "FPV Drone Pilot \xB7 Creator \xB7 Developer");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(13, "img", 9);
        \u0275\u0275elementEnd()();
      }
...
var MapComponent = class _MapComponent {
  ...
  providerPinStyle(feature) {
    ...
    const H = CY + R + 5;
    if (!canvas) {
      return new Style_default({ image: new Circle_default2({ radius: 18, fill: new Fill_default({ color: "#F4A922" }), stroke: new Stroke_default({ color: "#fff", width: 3 }) }) });
    }
    return new Style_default({
      image: new Icon_default({
        img: canvas,
  ...
  buildProviderCanvas(provider) {
    ...
    canvas.height = H;
    const ctx = canvas.getContext("2d");
    const label = provider.mapLabel ?? "\u{1F3F7}\uFE0F Deal";
    ...
    ctx.textAlign = "center";
    ctx.textBaseline = "middle";
    ctx.fillText(provider.emoji ?? "\u{1F3F7}\uFE0F", CX, CY + 1);
    return canvas;
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavInterstitialComponent, { className: "NavInterstitialComponent", filePath: "src/app/components/nav-interstitial/nav-interstitial.component.ts", lineNumber: 16 });
})();
...
function MaltaShellComponent_app_nav_interstitial_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("providerSelected", function MaltaShellComponent_app_nav_interstitial_0_Template_app_nav_interstitial_providerSelected_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      ctx_r2.bridge.interstitialProviderSelected$.next($event);
      return \u0275\u0275resetView(ctx_r2.bridge.pendingNavUrl.set(null));
    })("closed", function MaltaShellComponent_app_nav_interstitial_0_Template_app_nav_interstitial_closed_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.bridge.pendingNavUrl.set(null));
    });
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("url", ctx_r2.bridge.pendingNavUrl())("duration", ctx_r2.bridge.navDuration())("providers", ctx_r2.bridge.interstitialProviders());
  }
}
function MaltaShellComponent_app_filter_bar_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-filter-bar", 14);
...
var MaltaShellComponent = class _MaltaShellComponent {
  ...
  static {
    ...
    }, features: [\u0275\u0275ProvidersFeature([MapBridgeService])], decls: 15, vars: 11, consts: [["mapComp", ""], ["panelWrap", ""], [3, "url", "duration", "providers", "providerSelected", "closed", 4, "ngIf"], [1, "map-layout"], [1, "map-layout__main"], [1, "map-layout__map"], [3, "filterChange", 4, "ngIf"], [3, "locationSelected", "providerPinSelected", "mapTapped", "gpsCoord", "activeFilters", "providerPins", "selectedLocation"], ["class", "floating-back-btn", 3, "floating-back-btn--accent", "click", 4, "ngIf"], ["class", "show-panel-btn", 3, "show-panel-btn--primary", "click", 4, "ngIf"], ["class", "offline-pill", 4, "ngIf"], [1, "map-layout__panel"], ["class", "collapse-btn", "title", "Fullscreen map", 3, "click", 4, "ngIf"], [3, "providerSelected", "closed", "url", "duration", "providers"], [3, "filterChange"], [1, "floating-back-btn", 3, "click"], [1, "fa", "fa-chevron-left"], [1, "show-panel-btn", 3, "click"], [1, "fa", 3, "ngClass"], [1, "offline-pill"], [1, "offline-dot"], ["title", "Fullscreen map", 1, "collapse-btn", 3, "click"], [1, "fa", "fa-chevron-right"]], template: function MaltaShellComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275template(0, MaltaShellComponent_app_nav_interstitial_0_Template, 1, 3, "app-nav-interstitial", 2);
    ...
    }, dependencies: [CommonModule, NgClass, NgIf, RouterOutlet, MapComponent, FilterBarComponent, NavInterstitialComponent, FooterComponent], styles: ["\n\napp-filter-bar[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 10px;\n  left: 50%;\n  transform: translateX(-50%);\n  z-index: 10;\n  pointer-events: auto;\n  max-width: calc(100vw - 24px);\n  width: max-content;\n}\n.offline-pill[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 25px;\n  left: 50%;\n  transform: translateX(-50%);\n  z-index: 10;\n  background: rgba(30, 30, 30, 0.88);\n  color: #fff;\n  font-size: 12px;\n  font-weight: 500;\n  padding: 6px 14px;\n  border-radius: var(--radius-pill, 20px);\n  display: flex;\n  align-items: center;\n  gap: 7px;\n  white-space: nowrap;\n  -webkit-backdrop-filter: blur(6px);\n  backdrop-filter: blur(6px);\n  pointer-events: none;\n}\n.offline-dot[_ngcontent-%COMP%] {\n  width: 7px;\n  height: 7px;\n  border-radius: 50%;\n  background: #f87171;\n  flex-shrink: 0;\n}\n.show-panel-btn--primary[_ngcontent-%COMP%] {\n  color: var(--color-primary);\n  font-size: 16px;\n}\n.panel--hidden[_ngcontent-%COMP%] {\n  display: none;\n}\n/*# sourceMappingURL=malta-shell.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MaltaShellComponent, { className: "MaltaShellComponent", filePath: "src/app/platform/malta-shell/malta-shell.component.ts", lineNumber: 21 });
})();
export {
  MaltaShellComponent
};
//# sourceMappingURL=chunk-JYYORO7A.js.map
