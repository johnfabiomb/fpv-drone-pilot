...
function BookPageComponent_div_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(8);
    \u0275\u0275property("href", ctx_r0.invoiceUrl + "&auto=download", \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
    \u0275\u0275property("href", ctx_r0.invoiceUrl + "&auto=print", \u0275\u0275sanitizeUrl);
  }
}
...
function BookPageComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275element(13, "app-booking-invoice", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(12, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_2_button_12_Template, 9, 13, "button", 38);
    \u0275\u0275elementEnd();
...
function BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(0, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_ng_template_2_div_0_Template, 3, 0, "div", 44);
...
function BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_ng_container_1_Template, 8, 8, "ng-container", 41)(2, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_ng_template_2_Template, 5, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function BookPageComponent_ng_container_8_div_1_ng_container_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "div", 30);
    \u0275\u0275template(2, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_2_Template, 15, 7, "ng-container", 5)(3, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_Template, 4, 2, "ng-container", 5)(4, BookPageComponent_ng_container_8_div_1_ng_container_25_p_4_Template, 2, 1, "p", 31);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function BookPageComponent_ng_container_8_div_1_ng_container_26_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" Deposit of ", \u0275\u0275pipeBind4(5, 5, ctx_r0.totalPaid(), "EUR", "symbol", "1.2-2"), " already paid ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(12, 10, ctx_r0.remainingAmount, "EUR", "symbol", "1.2-2"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Completes your booking \u2014 total ", \u0275\u0275pipeBind4(15, 15, b_r2.price_total, "EUR", "symbol", "1.2-2"), "");
    \u0275\u0275advance(5);
    \u0275\u0275property("href", ctx_r0.invoiceUrl + "&auto=download", \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
    \u0275\u0275property("href", ctx_r0.invoiceUrl + "&auto=print", \u0275\u0275sanitizeUrl);
...
function BookPageComponent_ng_container_8_div_1_ng_container_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "div", 30);
    \u0275\u0275elementStart(2, "div", 50)(3, "span");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(7, "currency");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, BookPageComponent_ng_container_8_div_1_ng_container_27_div_8_Template, 4, 0, "div", 52);
    \u0275\u0275element(9, "div", 53);
    \u0275\u0275template(10, BookPageComponent_ng_container_8_div_1_ng_container_27_p_10_Template, 2, 1, "p", 31);
    ...
    \u0275\u0275template(15, BookPageComponent_ng_container_8_div_1_ng_container_27_span_15_Template, 1, 0, "span", 57);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
...
function BookPageComponent_ng_container_8_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(10, BookPageComponent_ng_container_8_div_1_div_10_Template, 5, 1, "div", 24)(11, BookPageComponent_ng_container_8_div_1_div_11_Template, 5, 1, "div", 24);
...
function BookPageComponent_ng_container_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, BookPageComponent_ng_container_8_div_1_Template, 28, 21, "div", 17);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
//# sourceMappingURL=chunk-7VLR6HGK.js.map
