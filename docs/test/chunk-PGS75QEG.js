...
var MapComponent = class _MapComponent {
  ...
  ngAfterViewInit() {
    ...
    this.activatedRoute.queryParams.pipe(takeUntilDestroyed(this.destroyRef)).subscribe((params) => {
      ...
      if (params["locationId"]) {
        ...
        place = locations.find((loc) => loc.id === id) ?? null;
      } else if (params["title"]) {
        place = locations.find((loc) => encodeURIComponent(loc.title) === params["title"]) ?? locations.find((loc) => encodeURIComponent(loc.title.replace(" ", "-")) === params["title"]) ?? null;
      }
      if (place) {
  ...
  getLocationMapCoordinates(location) {
    if (location.mapPoints?.length) {
      const dest = location.mapPoints.find((p) => p.type === "destination") ?? location.mapPoints[location.mapPoints.length - 1];
...
// src/app/platform/malta-shell/malta-shell.component.ts
var _c02 = ["panelWrap"];
function MaltaShellComponent_app_nav_interstitial_0_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275element(1, "app-coupon-reminder", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function MaltaShellComponent_app_nav_interstitial_0_div_2_p_1_Template(rf, ctx) {
  if (rf & 1) {
...
function MaltaShellComponent_app_nav_interstitial_0_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275template(1, MaltaShellComponent_app_nav_interstitial_0_div_2_p_1_Template, 2, 1, "p", 18);
    \u0275\u0275elementStart(2, "app-provider-card", 19);
    \u0275\u0275listener("selected", function MaltaShellComponent_app_nav_interstitial_0_div_2_Template_app_provider_card_selected_2_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function MaltaShellComponent_app_nav_interstitial_0_app_provider_card_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-provider-card", 21);
    \u0275\u0275listener("selected", function MaltaShellComponent_app_nav_interstitial_0_app_provider_card_3_Template_app_provider_card_selected_0_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onInterstitialProviderSelected($event));
    });
...
function MaltaShellComponent_app_nav_interstitial_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-nav-interstitial", 13);
    \u0275\u0275listener("closed", function MaltaShellComponent_app_nav_interstitial_0_Template_app_nav_interstitial_closed_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onInterstitialClosed());
    });
    \u0275\u0275template(1, MaltaShellComponent_app_nav_interstitial_0_div_1_Template, 2, 1, "div", 14)(2, MaltaShellComponent_app_nav_interstitial_0_div_2_Template, 3, 2, "div", 14)(3, MaltaShellComponent_app_nav_interstitial_0_app_provider_card_3_Template, 1, 1, "app-provider-card", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function MaltaShellComponent_app_filter_bar_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-filter-bar", 22);
    \u0275\u0275listener("filterChange", function MaltaShellComponent_app_filter_bar_4_Template_app_filter_bar_filterChange_0_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
...
function MaltaShellComponent_button_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 23);
    \u0275\u0275listener("click", function MaltaShellComponent_button_7_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
...
function MaltaShellComponent_button_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 25);
    \u0275\u0275listener("click", function MaltaShellComponent_button_8_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
...
function MaltaShellComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
...
function MaltaShellComponent_button_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 29);
    \u0275\u0275listener("click", function MaltaShellComponent_button_12_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
...
var MaltaShellComponent = class _MaltaShellComponent {
  constructor() {
  ...
  static {
    this.\u0275fac = function MaltaShellComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _MaltaShellComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MaltaShellComponent, selectors: [["app-malta-shell"]], viewQuery: function MaltaShellComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c02, 5);
    ...
    }, hostBindings: function MaltaShellComponent_HostBindings(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275listener("online", function MaltaShellComponent_online_HostBindingHandler() {
          return ctx.onOnline();
        }, false, \u0275\u0275resolveWindow)("offline", function MaltaShellComponent_offline_HostBindingHandler() {
          return ctx.onOffline();
        }, false, \u0275\u0275resolveWindow);
      }
    }, features: [\u0275\u0275ProvidersFeature([MapBridgeService])], decls: 15, vars: 11, consts: [["mapComp", ""], ["panelWrap", ""], [3, "url", "duration", "buttonLabel", "openNewTab", "closed", 4, "ngIf"], [1, "map-layout"], [1, "map-layout__main"], [1, "map-layout__map"], [3, "filterChange", 4, "ngIf"], [3, "locationSelected", "providerPinSelected", "mapTapped", "gpsCoord", "activeFilters", "providerPins", "selectedLocation"], ["class", "floating-back-btn", 3, "floating-back-btn--accent", "click", 4, "ngIf"], ["class", "show-panel-btn", 3, "show-panel-btn--primary", "click", 4, "ngIf"], ["class", "offline-pill", 4, "ngIf"], [1, "map-layout__panel"], ["class", "collapse-btn", "title", "Fullscreen map", 3, "click", 4, "ngIf"], [3, "closed", "url", "duration", "buttonLabel", "openNewTab"], ["slot-top", "", 4, "ngIf"], ["slot-bottom", "", 3, "provider", "selected", 4, "ngIf"], ["slot-top", ""], [3, "provider"], ["class", "interstitial-near-label", 4, "ngIf"], [3, "selected", "provider"], [1, "interstitial-near-label"], ["slot-bottom", "", 3, "selected", "provider"], [3, "filterChange"], [1, "floating-back-btn", 3, "click"], [1, "fa", "fa-chevron-left"], [1, "show-panel-btn", 3, "click"], [1, "fa", 3, "ngClass"], [1, "offline-pill"], [1, "offline-dot"], ["title", "Fullscreen map", 1, "collapse-btn", 3, "click"], [1, "fa", "fa-chevron-right"]], template: function MaltaShellComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275template(0, MaltaShellComponent_app_nav_interstitial_0_Template, 4, 7, "app-nav-interstitial", 2);
        \u0275\u0275elementStart(1, "div", 3)(2, "div", 4)(3, "div", 5);
        \u0275\u0275template(4, MaltaShellComponent_app_filter_bar_4_Template, 1, 0, "app-filter-bar", 6);
        \u0275\u0275elementStart(5, "app-map", 7, 0);
        \u0275\u0275listener("locationSelected", function MaltaShellComponent_Template_app_map_locationSelected_5_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.bridge.locationSelected$.next($event));
        })("providerPinSelected", function MaltaShellComponent_Template_app_map_providerPinSelected_5_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.bridge.providerPinSelected$.next($event));
        })("mapTapped", function MaltaShellComponent_Template_app_map_mapTapped_5_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onMapTapped());
        })("gpsCoord", function MaltaShellComponent_Template_app_map_gpsCoord_5_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.bridge.gpsCoord$.next($event));
        });
        \u0275\u0275elementEnd();
        \u0275\u0275template(7, MaltaShellComponent_button_7_Template, 3, 3, "button", 8)(8, MaltaShellComponent_button_8_Template, 2, 3, "button", 9)(9, MaltaShellComponent_div_9_Template, 3, 0, "div", 10);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(10, "div", 11, 1);
        \u0275\u0275template(12, MaltaShellComponent_button_12_Template, 2, 0, "button", 12);
    ...
    }, dependencies: [CommonModule, NgClass, NgIf, RouterOutlet, MapComponent, FilterBarComponent, NavInterstitialComponent, CouponReminderComponent, ProviderCardComponent, FooterComponent], styles: ["\n\napp-filter-bar[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 10px;\n  left: 50%;\n  transform: translateX(-50%);\n  z-index: 10;\n  pointer-events: auto;\n  max-width: calc(100vw - 24px);\n  width: max-content;\n}\n.offline-pill[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 25px;\n  left: 50%;\n  transform: translateX(-50%);\n  z-index: 10;\n  background: rgba(30, 30, 30, 0.88);\n  color: #fff;\n  font-size: 12px;\n  font-weight: 500;\n  padding: 6px 14px;\n  border-radius: var(--radius-pill, 20px);\n  display: flex;\n  align-items: center;\n  gap: 7px;\n  white-space: nowrap;\n  -webkit-backdrop-filter: blur(6px);\n  backdrop-filter: blur(6px);\n  pointer-events: none;\n}\n.offline-dot[_ngcontent-%COMP%] {\n  width: 7px;\n  height: 7px;\n  border-radius: 50%;\n  background: #f87171;\n  flex-shrink: 0;\n}\n.interstitial-near-label[_ngcontent-%COMP%] {\n  margin: 0 0 8px;\n  font-size: 10.5px;\n  font-weight: 700;\n  letter-spacing: 0.07em;\n  text-transform: uppercase;\n  color: #9ca3af;\n}\n.show-panel-btn--primary[_ngcontent-%COMP%] {\n  color: var(--color-primary);\n  font-size: 16px;\n}\n.panel--hidden[_ngcontent-%COMP%] {\n  display: none;\n}\n/*# sourceMappingURL=malta-shell.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MaltaShellComponent, { className: "MaltaShellComponent", filePath: "src/app/platform/malta-shell/malta-shell.component.ts", lineNumber: 24 });
})();
export {
  MaltaShellComponent
};
