...
function BookingFormComponent_Conditional_10_Conditional_0_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 11)(1, "input", 18);
...
function BookingFormComponent_Conditional_10_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("href", "/book/invoice/" + done_r4.id + "?auto=download", \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
    \u0275\u0275property("href", "/book/invoice/" + done_r4.id + "?auto=print", \u0275\u0275sanitizeUrl);
  }
}
...
function BookingFormComponent_Conditional_11_Conditional_10_For_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", c_r7.name, "", c_r7.company ? " \xB7 " + c_r7.company : "", "");
  }
}
...
function BookingFormComponent_Conditional_11_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 53)(1, "select", 54);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(4, BookingFormComponent_Conditional_11_Conditional_10_For_5_Template, 2, 3, "option", 26, _forTrack02);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(7, "+ New");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, BookingFormComponent_Conditional_11_Conditional_10_Conditional_8_Template, 2, 0, "span", 28);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
...
function BookingFormComponent_Conditional_11_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, BookingFormComponent_Conditional_11_Conditional_25_For_1_Template, 2, 1, "div", 57, _forTrack1);
...
function BookingFormComponent_Conditional_11_Conditional_59_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, BookingFormComponent_Conditional_11_Conditional_59_Conditional_11_Conditional_4_Template, 4, 12, "span", 28);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function BookingFormComponent_Conditional_11_Conditional_59_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 38)(1, "div", 21)(2, "label");
    \u0275\u0275text(3, "Deposit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, BookingFormComponent_Conditional_11_Conditional_59_Conditional_11_Template, 5, 2, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function BookingFormComponent_Conditional_11_Conditional_66_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "label", 40)(1, "input", 62);
    \u0275\u0275twoWayListener("ngModelChange", function BookingFormComponent_Conditional_11_Conditional_66_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r2.addToCalendar, $event) || (ctx_r2.addToCalendar = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "span")(3, "strong");
    \u0275\u0275text(4, "Confirmed \u2014 add to my calendar now");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "span", 42);
    \u0275\u0275text(6, "Pushes it to your Google Calendar straight away. Uncheck to wait until the client pays / confirms.");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.addToCalendar);
  }
}
...
function BookingFormComponent_Conditional_11_Conditional_84_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-availability-picker", 63);
...
function BookingFormComponent_Conditional_11_Conditional_85_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 51)(1, "div", 64);
    \u0275\u0275text(2, "\u{1F4C5}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
...
function BookingFormComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(18, BookingFormComponent_Conditional_11_For_19_Template, 2, 2, "option", 26, _forTrack02);
    \u0275\u0275elementEnd();
    \u0275\u0275template(20, BookingFormComponent_Conditional_11_Conditional_20_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 21)(22, "label");
    \u0275\u0275text(23, "Time blocks");
    \u0275\u0275elementEnd();
    \u0275\u0275template(24, BookingFormComponent_Conditional_11_Conditional_24_Template, 2, 0, "span", 28)(25, BookingFormComponent_Conditional_11_Conditional_25_Template, 4, 0)(26, BookingFormComponent_Conditional_11_Conditional_26_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 21)(28, "label");
    \u0275\u0275text(29, "Title");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "input", 29);
    ...
    \u0275\u0275text(35, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "app-line-items-editor", 31);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "div", 21)(40, "label");
    \u0275\u0275text(41, "Location ");
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "div", 21)(46, "label");
    \u0275\u0275text(47, "Payment options on the link");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "select", 34);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(59, BookingFormComponent_Conditional_11_Conditional_59_Template, 12, 2, "div", 38);
    \u0275\u0275elementStart(60, "div", 21)(61, "label");
    \u0275\u0275text(62, "Notes ");
    \u0275\u0275elementStart(63, "span", 32);
    \u0275\u0275text(64, "(optional, internal)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(65, "textarea", 39);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(66, BookingFormComponent_Conditional_11_Conditional_66_Template, 7, 1, "label", 40);
    \u0275\u0275elementStart(67, "label", 40)(68, "input", 41);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(74, BookingFormComponent_Conditional_11_Conditional_74_Template, 2, 1, "p", 43);
    \u0275\u0275elementStart(75, "div", 44)(76, "button", 45);
    ...
    \u0275\u0275text(79);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(80, "aside", 47)(81, "div", 48)(82, "h2", 49);
    \u0275\u0275text(83, "Worker availability");
    \u0275\u0275elementEnd();
    \u0275\u0275template(84, BookingFormComponent_Conditional_11_Conditional_84_Template, 1, 4, "app-availability-picker", 50)(85, BookingFormComponent_Conditional_11_Conditional_85_Template, 5, 0, "div", 51);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(86, "app-client-editor", 52);
...
//# sourceMappingURL=chunk-IGRWPMKR.js.map
