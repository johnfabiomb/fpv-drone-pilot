...
function LocationDetailComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 20)(4, "button", 21);
...
function LocationDetailComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, LocationDetailComponent_div_4_span_1_Template, 2, 1, "span", 32)(2, LocationDetailComponent_div_4_span_2_Template, 3, 1, "span", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_div_8_app_provider_card_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-provider-card", 40);
...
function LocationDetailComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, LocationDetailComponent_div_8_app_provider_card_3_Template, 1, 1, "app-provider-card", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_ng_container_16_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function LocationDetailComponent_ng_container_16_ng_container_2_div_1_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
...
function LocationDetailComponent_ng_container_16_ng_container_2_div_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 49);
    \u0275\u0275listener("click", function LocationDetailComponent_ng_container_16_ng_container_2_div_1_div_4_Template_div_click_0_listener() {
...
function LocationDetailComponent_ng_container_16_ng_container_2_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 45)(1, "div", 46);
    \u0275\u0275template(2, LocationDetailComponent_ng_container_16_ng_container_2_div_1_ng_container_2_Template, 2, 1, "ng-container", 47);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, LocationDetailComponent_ng_container_16_ng_container_2_div_1_div_4_Template, 5, 1, "div", 48);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LocationDetailComponent_ng_container_16_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LocationDetailComponent_ng_container_16_ng_container_2_div_1_Template, 5, 3, "div", 43);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function LocationDetailComponent_ng_container_16_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LocationDetailComponent_ng_container_16_div_3_Template_div_click_3_listener() {
...
function LocationDetailComponent_ng_container_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LocationDetailComponent_ng_container_16_div_1_Template, 3, 0, "div", 41)(2, LocationDetailComponent_ng_container_16_ng_container_2_Template, 2, 1, "ng-container", 42)(3, LocationDetailComponent_ng_container_16_div_3_Template, 8, 1, "div", 43);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_ng_template_17_div_0_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 44);
    \u0275\u0275element(1, "i", 13);
...
function LocationDetailComponent_ng_template_17_div_0_div_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 49);
    \u0275\u0275listener("click", function LocationDetailComponent_ng_template_17_div_0_div_4_Template_div_click_0_listener() {
...
function LocationDetailComponent_ng_template_17_div_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 45);
    \u0275\u0275template(1, LocationDetailComponent_ng_template_17_div_0_div_1_Template, 3, 0, "div", 41);
    \u0275\u0275elementStart(2, "div", 46);
    \u0275\u0275text(3, "Google Maps directions");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, LocationDetailComponent_ng_template_17_div_0_div_4_Template, 5, 1, "div", 48);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function LocationDetailComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, LocationDetailComponent_ng_template_17_div_0_Template, 5, 2, "div", 43);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_div_19_div_4_span_5_Template(rf, ctx) {
  if (rf & 1) {
...
function LocationDetailComponent_div_19_div_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 55);
    \u0275\u0275listener("click", function LocationDetailComponent_div_19_div_4_Template_div_click_0_listener() {
      const item_r20 = \u0275\u0275restoreView(_r19).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.clickon(item_r20.location));
    });
    \u0275\u0275element(1, "img", 56);
    \u0275\u0275elementStart(2, "div", 57)(3, "span", 58);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, LocationDetailComponent_div_19_div_4_span_5_Template, 2, 1, "span", 59);
    \u0275\u0275elementEnd();
...
function LocationDetailComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 51)(1, "h4", 52);
    \u0275\u0275text(2, "Closest Spots");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 53);
    \u0275\u0275template(4, LocationDetailComponent_div_19_div_4_Template, 10, 5, "div", 54);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LocationDetailComponent, selectors: [["app-location-detail"]], inputs: { location: "location", userLat: "userLat", userLon: "userLon", activeRouteIndex: "activeRouteIndex" }, outputs: { close: "close", explore: "explore", navRequested: "navRequested", providerSelected: "providerSelected" }, features: [\u0275\u0275NgOnChangesFeature], decls: 20, vars: 12, consts: [["singleRouteNav", ""], ["class", "confirm-banner", 4, "ngIf"], ["class", "nearby-banner", 4, "ngIf"], ["class", "hiking-active", 4, "ngIf"], [1, "px-header"], ["class", "meta", 4, "ngIf"], [3, "src"], [1, "px-2"], [1, "description", 3, "innerHTML"], ["class", "nearby-experiences", 4, "ngIf"], [1, "actions"], [1, "actions-row"], [1, "button", 3, "click"], [1, "fa", "fa-map"], ["label", "Share", 3, "url", "shareTitle"], [1, "divider"], [4, "ngIf", "ngIfElse"], ["class", "closest-section", 4, "ngIf"], [1, "confirm-banner"], [1, "confirm-text"], [1, "confirm-actions"], [1, "confirm-stay", 3, "click"], [1, "confirm-leave", 3, "click"], [1, "nearby-banner"], [1, "nearby-banner__text"], [1, "fa", "fa-map-marker"], [1, "nearby-banner__actions"], [1, "nearby-btn", "nearby-btn--stay", 3, "click"], [1, "nearby-btn", "nearby-btn--start", 3, "click"], [1, "hiking-active"], [1, "fa", "fa-street-view"], [1, "meta"], ["class", "tag", 4, "ngFor", "ngForOf"], ["class", "rating", 4, "ngIf"], [1, "tag"], [1, "rating"], [1, "fa", "fa-star"], [1, "nearby-experiences"], [1, "nearby-experiences__label"], [3, "provider", "selected", 4, "ngFor", "ngForOf"], [3, "selected", "provider"], ["class", "route-alert", 4, "ngIf"], [4, "ngFor", "ngForOf", "ngForTrackBy"], ["class", "nav-section", 4, "ngIf"], [1, "route-alert"], [1, "nav-section"], [1, "nav-section__label"], [4, "ngIf"], ["class", "button nav-btn", 3, "click", 4, "ngFor", "ngForOf"], [1, "button", "nav-btn", 3, "click"], [1, "nav-btn__hint"], [1, "closest-section"], [1, "closest-title"], [1, "closest-list"], ["class", "closest-card", 3, "click", 4, "ngFor", "ngForOf"], [1, "closest-card", 3, "click"], [1, "closest-thumb", 3, "src", "alt"], [1, "closest-info"], [1, "closest-name"], ["class", "closest-tag", 4, "ngIf"], [1, "closest-dist"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.5", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "closest-arrow"], ["points", "9 18 15 12 9 6"], [1, "closest-tag"]], template: function LocationDetailComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        let tmp_9_0;
        let tmp_10_0;
        const singleRouteNav_r21 = \u0275\u0275reference(18);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", ctx.activeRouteIndex < 0 && ((tmp_10_0 = ctx.location == null ? null : ctx.location.routes == null ? null : ctx.location.routes.length) !== null && tmp_10_0 !== void 0 ? tmp_10_0 : 0) >= 2)("ngIfElse", singleRouteNav_r21);
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LocationDetailComponent, { className: "LocationDetailComponent", filePath: "src/app/components/location-detail/location-detail.component.ts", lineNumber: 23 });
})();
...
//# sourceMappingURL=chunk-PQYYKHV4.js.map
