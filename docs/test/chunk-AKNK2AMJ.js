...
var mapRoutes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-GVGLKFBM.js").then((m) => m.MapRootComponent),
    children: [
      {
        path: "",
        pathMatch: "full",
      ...
      },
      {
        ...
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-SD2NLEJW.js").then((m) => m.MapShellComponent),
            children: [
              {
                path: "",
                pathMatch: "full",
...
//# sourceMappingURL=chunk-AKNK2AMJ.js.map
