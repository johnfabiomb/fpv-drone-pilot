...
var DEFAULT_DESC = "Discover Malta's best hidden gems, secret caves, beaches and historical sites with a free interactive map by John Monta\xF1o. 70+ curated locations with routes, photos and partner deals.";
var SeoService = class _SeoService {
  ...
  setTrendPage(revealed) {
    const title = "30 Best Places to Visit in Malta (2026) \xB7 Explorer's Guide";
  ...
  setProviderPage(provider) {
    const title = `${provider.name} \xB7 Malta ${this.categoryLabel(provider.category)} | Explore Malta`;
...
//# sourceMappingURL=chunk-2WBO6UKF.js.map
