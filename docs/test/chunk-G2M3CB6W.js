...
var MapComponent = class _MapComponent {
  ...
  set activeFilters(filters) {
    this.filteredFeatures = filters.length === 0 ? this.allFeatures : this.allFeatures.filter((f) => filters.some((flt) => this.matchesFilter(f.get("location"), flt)));
  ...
  constructor(activatedRoute, router, seoService, analyticsService) {
  ...
  ngAfterViewInit() {
    ...
    this.activatedRoute.queryParams.subscribe((params) => {
      ...
      if (params["locationId"]) {
        ...
        place = locations.find((loc) => loc.id === id);
      } else if (params["title"]) {
        place = locations.find((loc) => encodeURIComponent(loc.title) === params["title"]) ?? locations.find((loc) => encodeURIComponent(loc.title.replace(" ", "-")) === params["title"]);
      }
      if (place) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MapComponent, { className: "MapComponent", filePath: "src/app/components/map/map.component.ts", lineNumber: 30 });
})();
...
var FilterBarComponent = class _FilterBarComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FilterBarComponent, selectors: [["app-filter-bar"]], outputs: { filterChange: "filterChange" }, standalone: false, decls: 7, vars: 8, consts: [[1, "filter-bar"], [1, "chip", 3, "click"], ["class", "emoji", 4, "ngIf"], [1, "label"], ["class", "chip-x", 4, "ngIf"], ["class", "chip", 3, "active", "click", 4, "ngFor", "ngForOf"], [1, "emoji"], [1, "chip-x"]], template: function FilterBarComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var ComponentsModule = class _ComponentsModule {
  ...
  static {
    this.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _ComponentsModule });
  }
  static {
...
//# sourceMappingURL=chunk-G2M3CB6W.js.map
