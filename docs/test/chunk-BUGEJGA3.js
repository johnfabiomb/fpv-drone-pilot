...
function ExploreTogetherComponent_div_2_span_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ExploreTogetherComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 3)(1, "button", 4);
    \u0275\u0275listener("click", function ExploreTogetherComponent_div_2_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ExploreTogetherComponent_div_2_span_3_Template, 2, 1, "span", 5);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.migrating() ? "Updating\u2026" : "\u{1F527} Fix groups data", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.migrateResult());
  }
}
var ExploreTogetherComponent = class _ExploreTogetherComponent {
  ...
  runMigration() {
    return __async(this, null, function* () {
      ...
      try {
        const count = yield this.groupsService.migrateLeaderIsAdmin();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreTogetherComponent, selectors: [["app-explore-together"]], decls: 4, vars: 1, consts: [["title", "Explore Together", 3, "closeRequested", "dragStart", "dragMove", "dragEnd", "bodyDragStart", "bodyDragMove", "bodyDragEnd"], [1, "et-content"], ["class", "et-migration", 4, "ngIf"], [1, "et-migration"], [1, "et-migration__btn", 3, "click", "disabled"], ["class", "et-migration__result", 4, "ngIf"], [1, "et-migration__result"]], template: function ExploreTogetherComponent_Template(rf, ctx) {
      if (rf & 1) {
