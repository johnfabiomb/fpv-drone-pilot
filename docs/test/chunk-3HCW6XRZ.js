...
function PlatformShellComponent_Conditional_1_Conditional_10_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const org_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("/", org_r2.slug, "");
  }
}
function PlatformShellComponent_Conditional_1_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 8)(1, "span", 46)(2, "span", 47);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, PlatformShellComponent_Conditional_1_Conditional_10_Conditional_4_Template, 2, 1, "span", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
...
function PlatformShellComponent_Conditional_1_Conditional_26_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.data.bookings().length);
  }
}
...
function PlatformShellComponent_Conditional_1_Conditional_42_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.data.clients().length);
  }
}
function PlatformShellComponent_Conditional_1_Conditional_68_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.data.syncResult());
  }
}
function PlatformShellComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(10, PlatformShellComponent_Conditional_1_Conditional_10_Template, 7, 2, "a", 8);
    ...
    \u0275\u0275listener("click", function PlatformShellComponent_Conditional_1_Template_button_click_63_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.data.syncCalendar());
    });
    \u0275\u0275namespaceSVG();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(10);
    \u0275\u0275conditional((tmp_1_0 = ctx_r2.activeOrg()) ? 10 : -1, tmp_1_0);
    \u0275\u0275advance(16);
    \u0275\u0275conditional(ctx_r2.data.bookings().length > 0 ? 26 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.auth.features().work_board ? 27 : -1);
    \u0275\u0275advance(15);
    \u0275\u0275conditional(ctx_r2.data.clients().length > 0 ? 42 : -1);
    \u0275\u0275advance(21);
    \u0275\u0275property("disabled", ctx_r2.data.syncing());
    \u0275\u0275advance();
    \u0275\u0275classProp("sync-btn__icon--spinning", ctx_r2.data.syncing());
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r2.data.syncing() ? "Syncing\u2026" : "Sync Calendar", " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.data.syncResult() ? 68 : -1);
  }
}
