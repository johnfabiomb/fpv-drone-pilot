...
var InvoiceComponent = class _InvoiceComponent {
  ...
  ngOnInit() {
    return __async(this, null, function* () {
      ...
      const { data, error } = yield bookingsDb.rpc("get_invoice", { p_booking: id });
      if (error || !data) {
        this.state.set("error");
        return;
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InvoiceComponent, { className: "InvoiceComponent", filePath: "src/app/booking/public/invoice/invoice.component.ts", lineNumber: 28 });
})();
export {
  InvoiceComponent
};
//# sourceMappingURL=chunk-UKZOQTJI.js.map
