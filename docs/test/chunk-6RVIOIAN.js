...
function LocationDetailComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, LocationDetailComponent_div_4_span_1_Template, 2, 1, "span", 35)(2, LocationDetailComponent_div_4_span_2_Template, 3, 1, "span", 36);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_div_8_app_provider_card_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-provider-card", 43);
...
function LocationDetailComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, LocationDetailComponent_div_8_app_provider_card_3_Template, 1, 1, "app-provider-card", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_ng_container_19_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47);
    \u0275\u0275element(1, "i", 13);
    \u0275\u0275text(2, " Follow the routes on the map above \u2014 Google Maps may take different paths. ");
    \u0275\u0275elementEnd();
  }
}
function LocationDetailComponent_ng_container_19_ng_container_2_div_1_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const group_r8 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", group_r8.route.emoji, "\xA0");
  }
}
function LocationDetailComponent_ng_container_19_ng_container_2_div_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 52);
    \u0275\u0275listener("click", function LocationDetailComponent_ng_container_19_ng_container_2_div_1_div_4_Template_div_click_0_listener() {
      const ctx_r9 = \u0275\u0275restoreView(_r9);
      const point_r11 = ctx_r9.$implicit;
      const i_r12 = ctx_r9.index;
      const group_r8 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.navigateTo(point_r11, i_r12, group_r8.points));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.pointLabel(point_r11, i_r12));
  }
}
function LocationDetailComponent_ng_container_19_ng_container_2_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 48)(1, "div", 49);
    \u0275\u0275template(2, LocationDetailComponent_ng_container_19_ng_container_2_div_1_ng_container_2_Template, 2, 1, "ng-container", 50);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, LocationDetailComponent_ng_container_19_ng_container_2_div_1_div_4_Template, 5, 1, "div", 51);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const group_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", group_r8.route.emoji);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", group_r8.route.label, " \u2014 directions ");
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", group_r8.points);
  }
}
function LocationDetailComponent_ng_container_19_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LocationDetailComponent_ng_container_19_ng_container_2_div_1_Template, 5, 3, "div", 46);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const group_r8 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", group_r8.points.length);
  }
}
function LocationDetailComponent_ng_container_19_div_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 48)(1, "div", 49);
    \u0275\u0275text(2, "\u{1F4CD} Final destination");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 52);
    \u0275\u0275listener("click", function LocationDetailComponent_ng_container_19_div_3_Template_div_click_3_listener() {
      const dest_r14 = \u0275\u0275restoreView(_r13).ngIf;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.navigateTo(dest_r14, 0));
    });
  ...
  if (rf & 2) {
    const dest_r14 = ctx.ngIf;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r2.pointLabel(dest_r14, 1));
  }
}
function LocationDetailComponent_ng_container_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LocationDetailComponent_ng_container_19_div_1_Template, 3, 0, "div", 44)(2, LocationDetailComponent_ng_container_19_ng_container_2_Template, 2, 1, "ng-container", 45)(3, LocationDetailComponent_ng_container_19_div_3_Template, 8, 1, "div", 46);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_ng_template_20_div_0_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47);
    \u0275\u0275element(1, "i", 13);
...
function LocationDetailComponent_ng_template_20_div_0_div_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 52);
    \u0275\u0275listener("click", function LocationDetailComponent_ng_template_20_div_0_div_4_Template_div_click_0_listener() {
      const ctx_r15 = \u0275\u0275restoreView(_r15);
      const point_r17 = ctx_r15.$implicit;
      const i_r18 = ctx_r15.index;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.navigateTo(point_r17, i_r18));
    });
    \u0275\u0275elementStart(1, "span");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.pointLabel(point_r17, i_r18));
  }
}
function LocationDetailComponent_ng_template_20_div_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 48);
    \u0275\u0275template(1, LocationDetailComponent_ng_template_20_div_0_div_1_Template, 3, 0, "div", 44);
    \u0275\u0275elementStart(2, "div", 49);
    \u0275\u0275text(3, "Google Maps directions");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, LocationDetailComponent_ng_template_20_div_0_div_4_Template, 5, 1, "div", 51);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function LocationDetailComponent_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, LocationDetailComponent_ng_template_20_div_0_Template, 5, 2, "div", 46);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_div_22_div_4_span_5_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.formatTag(item_r20.location.tags[0]));
  }
}
function LocationDetailComponent_div_22_div_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 58);
    \u0275\u0275listener("click", function LocationDetailComponent_div_22_div_4_Template_div_click_0_listener() {
      const item_r20 = \u0275\u0275restoreView(_r19).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.clickon(item_r20.location));
    });
    \u0275\u0275element(1, "img", 59);
    \u0275\u0275elementStart(2, "div", 60)(3, "span", 61);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, LocationDetailComponent_div_22_div_4_span_5_Template, 2, 1, "span", 62);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("src", item_r20.location.img, \u0275\u0275sanitizeUrl)("alt", item_r20.location.title);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r20.location.title);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", item_r20.location.tags[0]);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", item_r20.distanceKm, " km");
  }
}
function LocationDetailComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 54)(1, "h4", 55);
    \u0275\u0275text(2, "Closest Spots");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 56);
    \u0275\u0275template(4, LocationDetailComponent_div_22_div_4_Template, 10, 5, "div", 57);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LocationDetailComponent, selectors: [["app-location-detail"]], inputs: { location: "location", userLat: "userLat", userLon: "userLon", activeRouteIndex: "activeRouteIndex" }, outputs: { close: "close", explore: "explore", navRequested: "navRequested", providerSelected: "providerSelected" }, features: [\u0275\u0275NgOnChangesFeature], decls: 23, vars: 16, consts: [["singleRouteNav", ""], ["class", "confirm-banner", 4, "ngIf"], ["class", "nearby-banner", 4, "ngIf"], ["class", "hiking-active", 4, "ngIf"], [1, "px-header"], ["class", "meta", 4, "ngIf"], [3, "src"], [1, "px-2"], [1, "description", 3, "innerHTML"], ["class", "nearby-experiences", 4, "ngIf"], [1, "actions"], [1, "actions-row"], [1, "button", 3, "click"], [1, "fa", "fa-map"], ["label", "Share", 3, "url", "shareTitle"], [1, "save-btn", 3, "click", "title"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"], [1, "divider"], [4, "ngIf", "ngIfElse"], ["class", "closest-section", 4, "ngIf"], [1, "confirm-banner"], [1, "confirm-text"], [1, "confirm-actions"], [1, "confirm-stay", 3, "click"], [1, "confirm-leave", 3, "click"], [1, "nearby-banner"], [1, "nearby-banner__text"], [1, "fa", "fa-map-marker"], [1, "nearby-banner__actions"], [1, "nearby-btn", "nearby-btn--stay", 3, "click"], [1, "nearby-btn", "nearby-btn--start", 3, "click"], [1, "hiking-active"], [1, "fa", "fa-street-view"], [1, "meta"], ["class", "tag", 4, "ngFor", "ngForOf"], ["class", "rating", 4, "ngIf"], [1, "tag"], [1, "rating"], [1, "fa", "fa-star"], [1, "nearby-experiences"], [1, "nearby-experiences__label"], [3, "provider", "selected", 4, "ngFor", "ngForOf"], [3, "selected", "provider"], ["class", "route-alert", 4, "ngIf"], [4, "ngFor", "ngForOf", "ngForTrackBy"], ["class", "nav-section", 4, "ngIf"], [1, "route-alert"], [1, "nav-section"], [1, "nav-section__label"], [4, "ngIf"], ["class", "button nav-btn", 3, "click", 4, "ngFor", "ngForOf"], [1, "button", "nav-btn", 3, "click"], [1, "nav-btn__hint"], [1, "closest-section"], [1, "closest-title"], [1, "closest-list"], ["class", "closest-card", 3, "click", 4, "ngFor", "ngForOf"], [1, "closest-card", 3, "click"], [1, "closest-thumb", 3, "src", "alt"], [1, "closest-info"], [1, "closest-name"], ["class", "closest-tag", 4, "ngIf"], [1, "closest-dist"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.5", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "closest-arrow"], ["points", "9 18 15 12 9 6"], [1, "closest-tag"]], template: function LocationDetailComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275listener("click", function LocationDetailComponent_Template_button_click_15_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.toggleSave());
        });
        \u0275\u0275namespaceSVG();
        ...
        \u0275\u0275namespaceHTML();
        \u0275\u0275element(18, "hr", 18);
        \u0275\u0275template(19, LocationDetailComponent_ng_container_19_Template, 4, 4, "ng-container", 19)(20, LocationDetailComponent_ng_template_20_Template, 1, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd();
        \u0275\u0275template(22, LocationDetailComponent_div_22_Template, 5, 1, "div", 20);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_9_0;
        let tmp_13_0;
        const singleRouteNav_r21 = \u0275\u0275reference(21);
        ...
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", ctx.activeRouteIndex < 0 && ((tmp_13_0 = ctx.location == null ? null : ctx.location.routes == null ? null : ctx.location.routes.length) !== null && tmp_13_0 !== void 0 ? tmp_13_0 : 0) >= 2)("ngIfElse", singleRouteNav_r21);
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LocationDetailComponent, { className: "LocationDetailComponent", filePath: "src/app/components/location-detail/location-detail.component.ts", lineNumber: 24 });
})();
...
function LocationPageComponent_app_location_detail_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-location-detail", 4);
    \u0275\u0275listener("close", function LocationPageComponent_app_location_detail_2_Template_app_location_detail_close_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onClose());
    })("explore", function LocationPageComponent_app_location_detail_2_Template_app_location_detail_explore_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onClose());
    })("navRequested", function LocationPageComponent_app_location_detail_2_Template_app_location_detail_navRequested_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onNavRequested($event));
    })("providerSelected", function LocationPageComponent_app_location_detail_2_Template_app_location_detail_providerSelected_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LocationPageComponent, selectors: [["app-location-page"]], decls: 3, vars: 3, consts: [[3, "closeRequested", "dragStart", "dragMove", "dragEnd", "bodyDragStart", "bodyDragMove", "bodyDragEnd", "title"], ["panelActions", "", 3, "url", "shareTitle", 4, "ngIf"], [3, "location", "userLat", "userLon", "activeRouteIndex", "close", "explore", "navRequested", "providerSelected", 4, "ngIf"], ["panelActions", "", 3, "url", "shareTitle"], [3, "close", "explore", "navRequested", "providerSelected", "location", "userLat", "userLon", "activeRouteIndex"]], template: function LocationPageComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(1, LocationPageComponent_app_share_btn_1_Template, 1, 2, "app-share-btn", 1)(2, LocationPageComponent_app_location_detail_2_Template, 1, 4, "app-location-detail", 2);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_0_0;
    ...
    }, dependencies: [CommonModule, NgIf, PanelShellComponent, LocationDetailComponent, ShareButtonComponent], styles: ["\n\n[_nghost-%COMP%] {\n  display: contents;\n}\n/*# sourceMappingURL=location-page.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LocationPageComponent, { className: "LocationPageComponent", filePath: "src/app/platform/location-page/location-page.component.ts", lineNumber: 57 });
})();
export {
  LocationPageComponent
};
//# sourceMappingURL=chunk-6RVIOIAN.js.map
