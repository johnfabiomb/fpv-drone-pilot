...
var locations = [
  ...
  {
    id: 77,
    title: "Hidden Sea Cave near Xlendi",
    slug: "hidden-sea-cave-near-xlendi",
    description: "On Gozo's south coast, west of <b>Xlendi Bay</b>, a huge natural sea arch cuts into the rugged cliffs \u2014 a cathedral-like cave of raw, weathered rock quite unlike the smooth pale grottoes elsewhere on the island. It has no official name and no path from land: the only way in is by water. Launch a kayak from Xlendi Bay and paddle roughly a kilometre along the Sanap cliffs, and you'll round into a wide, shaded chamber opening onto deep turquoise water. Inside there's room to swim, snorkel along the rocky edges, or climb the pitted ledges for a cliff jump into the clear blue below. There are no facilities and the sea is the only access, so pick a calm day, bring water and shoes with grip, and check the swell and wind before you set off.",
    img: "/assets/images/places/hidden-sea-cave-near-xlendi/hidden-sea-cave-near-xlendi.webp",
    thumb: "/assets/images/places/hidden-sea-cave-near-xlendi/hidden-sea-cave-near-xlendi-thumb.webp",
    images: [
      "/assets/images/places/hidden-sea-cave-near-xlendi/hidden-sea-cave-near-xlendi.webp",
      "/assets/images/places/hidden-sea-cave-near-xlendi/hidden-sea-cave-near-xlendi-2.webp",
      "/assets/images/places/hidden-sea-cave-near-xlendi/hidden-sea-cave-near-xlendi-3.webp"
    ],
    lon: 14.209393688978437,
    lat: 36.03273534625865,
    keywords: "hidden sea cave Gozo, Xlendi sea cave, Sanap cliffs, Gozo kayaking cave, sea arch, cliff jumping, swimming, snorkeling, Xlendi Bay, Munxar, Malta",
    rating: 4.7,
    mapPoints: [
      {
...
//# sourceMappingURL=chunk-XUN3IHEA.js.map
