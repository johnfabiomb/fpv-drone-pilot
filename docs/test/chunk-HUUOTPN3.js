...
var allGroups = [[-1, "\u2728", "custom"], [0, "\u{1F600}", "smileys-emotion"], [1, "\u{1F44B}", "people-body"], [3, "\u{1F431}", "animals-nature"], [4, "\u{1F34E}", "food-drink"], [5, "\u{1F3E0}\uFE0F", "travel-places"], [6, "\u26BD", "activities"], [7, "\u{1F4DD}", "objects"], [8, "\u26D4\uFE0F", "symbols"], [9, "\u{1F3C1}", "flags"]].map(([id, emoji, name]) => ({
  id,
  emoji,
  name
}));
...
var MOST_COMMONLY_USED_EMOJI = ["\u{1F60A}", "\u{1F612}", "\u2764\uFE0F", "\u{1F44D}\uFE0F", "\u{1F60D}", "\u{1F602}", "\u{1F62D}", "\u263A\uFE0F", "\u{1F614}", "\u{1F629}", "\u{1F60F}", "\u{1F495}", "\u{1F64C}", "\u{1F618}"];
...
function createRoot(shadowRoot, props) {
  ...
  function getDetailForClickEvent(unicodeOrName) {
    return __async(this, null, function* () {
  ...
  function clickEmoji(unicodeOrName) {
    return __async(this, null, function* () {
      ...
      fireEvent("emoji-click", yield promiseForDetail);
    });
  }
...
//# sourceMappingURL=chunk-HUUOTPN3.js.map
