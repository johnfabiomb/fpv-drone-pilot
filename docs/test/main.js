...
var routes = [
  ...
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-YO4ILKNO.js").then((mod) => mod.HomeComponent)
  }, false ? { \u0275entryName: "src/app/pages/home/home.component.ts" } : {}),
  __spreadValues({
    path: "privacy",
    loadComponent: () => import("./chunk-ABDC6YUC.js").then((mod) => mod.PrivacyComponent)
  }, false ? { \u0275entryName: "src/app/pages/privacy/privacy.component.ts" } : {}),
  __spreadValues({
    path: "cookies",
    loadComponent: () => import("./chunk-YZQRUOBN.js").then((mod) => mod.CookiesComponent)
  }, false ? { \u0275entryName: "src/app/pages/cookies/cookies.component.ts" } : {}),
  __spreadValues({
    path: "about",
    loadComponent: () => import("./chunk-KTULR2XJ.js").then((mod) => mod.AboutComponent)
  }, false ? { \u0275entryName: "src/app/pages/about/about.component.ts" } : {}),
  __spreadValues({
    path: "contact",
    loadComponent: () => import("./chunk-YYNOWCK3.js").then((mod) => mod.ContactComponent)
  }, false ? { \u0275entryName: "src/app/pages/contact/contact.component.ts" } : {}),
  {
    ...
    children: [
      __spreadValues({
        ...
        path: "",
        loadComponent: () => import("./chunk-NRSFSMRL.js").then((m) => m.MapShellComponent),
        children: [
          {
            path: "",
            pathMatch: "full",
            loadComponent: () => import("./chunk-WS5K3HO7.js").then((mod) => mod.MapExploreComponent)
          },
          {
            path: "list",
            loadComponent: () => import("./chunk-SE6HFUZJ.js").then((m) => m.LocationListComponent)
          },
          {
            path: "deals",
            loadComponent: () => import("./chunk-LRYPBBOW.js").then((m) => m.DealsComponent)
          },
          {
            path: "providers/:id",
            loadComponent: () => import("./chunk-P7K43ZW4.js").then((m) => m.ProviderPageComponent)
          },
          {
            path: "locations/:slug",
            loadComponent: () => import("./chunk-2K76LNTT.js").then((m) => m.LocationPageComponent)
          },
          {
            path: "saved",
            loadComponent: () => import("./chunk-CVVMKKYD.js").then((m) => m.SavedPlacesComponent)
          },
          {
            path: "admin",
            canMatch: [() => inject(UserDataService).isAdmin()],
            loadComponent: () => import("./chunk-EE32BOJQ.js").then((m) => m.AdminPanelComponent)
          },
          {
            path: "groups",
            canMatch: [() => FEATURES.GROUPS],
            loadComponent: () => import("./chunk-2BX53TYP.js").then((m) => m.ExploreTogetherComponent)
          },
          {
            path: "groups/:id",
            canMatch: [() => FEATURES.GROUPS],
            loadComponent: () => import("./chunk-ASR5SL4L.js").then((m) => m.GroupDetailComponent)
          }
        ]
      ...
      __spreadValues({
        path: "30-places-2026",
        loadComponent: () => import("./chunk-MP4NPQLZ.js").then((m) => m.TopPlacesComponent)
      }, false ? { \u0275entryName: "src/app/pages/top-places/top-places.component.ts" } : {}),
      __spreadValues({
        path: "plan",
        canMatch: [() => FEATURES.ROUTE_BUILDER],
        loadComponent: () => import("./chunk-V5QYOL4L.js").then((m) => m.RouteBuilderComponent)
      }, false ? { \u0275entryName: "src/app/features/route-builder/route-builder.component.ts" } : {})
    ]
  },
  __spreadValues({
    path: "pay",
    loadComponent: () => import("./chunk-5ZPSKJMI.js").then((m) => m.PaymentComponent)
  }, false ? { \u0275entryName: "src/app/pages/payment/payment.component.ts" } : {}),
  __spreadValues({
    path: "pay/success",
    loadComponent: () => import("./chunk-N756XU4T.js").then((m) => m.PaymentSuccessComponent)
...
function AppComponent_app_edit_profile_modal_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-edit-profile-modal", 10);
    \u0275\u0275listener("saved", function AppComponent_app_edit_profile_modal_9_Template_app_edit_profile_modal_saved_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.editProfileModal.close());
    })("dismissed", function AppComponent_app_edit_profile_modal_9_Template_app_edit_profile_modal_dismissed_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.editProfileModal.close());
    });
...
var AppComponent = class _AppComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 10, vars: 7, consts: [[4, "ngIf"], [1, "app-version"], ["class", "level-up-toast", 4, "ngIf"], ["maxWidth", "280px"], [3, "closeRequested", 4, "ngIf"], [3, "isFirstLogin", "saved", "dismissed", 4, "ngIf"], [1, "level-up-toast"], ["maxWidth", "280px", 3, "closeRequested"], [3, "levelClicked", "photoURL", "displayName", "levelId", "levelLabel", "isAdmin", "roleLabel", "activeLabel", "levelClickable"], [3, "closeRequested"], [3, "saved", "dismissed", "isFirstLogin"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(6, AppComponent_div_6_Template, 2, 2, "div", 2)(7, AppComponent_Conditional_7_Template, 2, 8, "app-modal", 3)(8, AppComponent_app_levels_modal_8_Template, 1, 0, "app-levels-modal", 4)(9, AppComponent_app_edit_profile_modal_9_Template, 1, 1, "app-edit-profile-modal", 5);
      }
      if (rf & 2) {
        let tmp_4_0;
        \u0275\u0275advance();
