...
var bookingRoutes = [
  ...
  __spreadValues({
    path: "book",
    loadComponent: () => import("./chunk-ABOESQN4.js").then((m) => m.ServicePickerComponent)
  ...
  __spreadValues({
    ...
    path: "book/calendar",
    loadComponent: () => import("./chunk-Y2NACD4Y.js").then((m) => m.BookingCalendarComponent)
  }, false ? { \u0275entryName: "src/app/booking/public/booking-calendar/booking-calendar.component.ts" } : {}),
  __spreadValues({
    path: "book/checkout",
    loadComponent: () => import("./chunk-EYWKCPPO.js").then((m) => m.BookingCheckoutComponent)
  }, false ? { \u0275entryName: "src/app/booking/public/booking-checkout/booking-checkout.component.ts" } : {}),
  __spreadValues({
    path: "book/mine",
    loadComponent: () => import("./chunk-ZSD3TCQ4.js").then((m) => m.MyBookingsComponent)
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-UKZOQTJI.js").then((m) => m.InvoiceComponent)
  }, false ? { \u0275entryName: "src/app/booking/public/invoice/invoice.component.ts" } : {}),
  __spreadValues({
    path: "book/:token",
    loadComponent: () => import("./chunk-XNICEJYS.js").then((m) => m.BookPageComponent)
  }, false ? { \u0275entryName: "src/app/booking/public/book-page/book-page.component.ts" } : {}),
  __spreadValues({
    path: "pay/success",
    loadComponent: () => import("./chunk-BKGIHS4P.js").then((m) => m.PaymentSuccessComponent)
  ...
  // ── Studio (logged-in platform) ───────────────────────────────────
  {
    ...
    children: [
      __spreadValues({
        ...
        loadComponent: () => import("./chunk-HLFHQLXS.js").then((m) => m.LoginComponent)
      }, false ? { \u0275entryName: "src/app/booking/auth/login/login.component.ts" } : {}),
      __spreadValues({
        path: "",
        canActivate: [adminGuard],
        loadComponent: () => import("./chunk-EYOHZFLW.js").then((m) => m.PlatformShellComponent),
        children: [
          { path: "", redirectTo: "dashboard", pathMatch: "full" },
          {
            path: "dashboard",
            loadComponent: () => import("./chunk-DUL4ZYRX.js").then((m) => m.DashboardComponent)
          },
          {
            path: "list",
            loadComponent: () => import("./chunk-7CSUCSGY.js").then((m) => m.BookingListComponent)
          },
          {
            path: "new",
            loadComponent: () => import("./chunk-Q2ETTGFW.js").then((m) => m.BookingFormComponent)
          },
          {
            path: ":id/edit",
            loadComponent: () => import("./chunk-Q2ETTGFW.js").then((m) => m.BookingFormComponent)
          ...
          {
            path: "organizations",
            loadComponent: () => import("./chunk-HVJVL7BW.js").then((m) => m.OrganizationsComponent)
          },
          {
            path: "invoices",
            loadComponent: () => import("./chunk-2NUVIZ5B.js").then((m) => m.InvoicesAdminComponent)
          },
          {
            // literal segment, so it precedes the catch-all ':id' below
            path: "invoice-edit/:id",
            loadComponent: () => import("./chunk-CUJUIVUY.js").then((m) => m.InvoiceEditComponent)
          },
          {
            path: "clients",
            loadComponent: () => import("./chunk-5SMAYXNA.js").then((m) => m.ClientListComponent)
          },
          {
            path: "services",
            loadComponent: () => import("./chunk-XH7HHLNX.js").then((m) => m.ServicesAdminComponent)
          },
          {
            path: "staff",
            loadComponent: () => import("./chunk-6MFA6NRN.js").then((m) => m.StaffAdminComponent)
          },
          {
            path: "settings",
            loadComponent: () => import("./chunk-P7STOHQ6.js").then((m) => m.SettingsAdminComponent)
          },
          {
            path: "work",
            loadComponent: () => import("./chunk-3C2QXW7E.js").then((m) => m.WorkBoardComponent)
          },
          {
            ...
            path: ":id",
            loadComponent: () => import("./chunk-4ZKVYG24.js").then((m) => m.BookingDetailComponent)
          }
        ]
...
var routes = [
  ...
  __spreadValues({
    path: "",
    loadChildren: () => import("./chunk-NN3HYZ34.js").then((m) => m.mapRoutes)
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-4UUARDU6.js").then((m) => m);
