  ...
  }, false ? { \u0275entryName: "src/app/platform/contact/contact.component.ts" } : {}),
  {
    ...
    children: [
      __spreadValues({
        ...
        path: "",
        loadComponent: () => import("./chunk-TL44RSER.js").then((m) => m.MaltaShellComponent),
        children: [
          {
            path: "",
            pathMatch: "full",
            loadComponent: () => import("./chunk-XYJWE5PT.js").then((mod) => mod.MaltaMapComponent)
          },
          {
            path: "list",
            loadComponent: () => import("./chunk-CX7YOTJT.js").then((m) => m.LocationListComponent)
          },
          {
            path: "deals",
            loadComponent: () => import("./chunk-3TDBWZWL.js").then((m) => m.CouponsComponent)
          }
        ]
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-ATUVYSR7.js").then((m) => m);
