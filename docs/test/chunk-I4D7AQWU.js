...
function AdminPanelComponent_Conditional_12_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 24)(12, "button", 25);
...
function AdminPanelComponent_Conditional_12_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, AdminPanelComponent_Conditional_12_Conditional_5_For_2_Template, 16, 7, "div", 18, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminPanelComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, AdminPanelComponent_Conditional_12_Conditional_3_Template, 2, 0, "p", 13)(4, AdminPanelComponent_Conditional_12_Conditional_4_Template, 2, 0, "p", 13)(5, AdminPanelComponent_Conditional_12_Conditional_5_Template, 3, 0, "div", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminPanelComponent, selectors: [["app-admin-panel"]], decls: 13, vars: 10, consts: [["title", "Admin Panel", 3, "closeRequested"], [1, "ap-content"], [1, "ap-tabs"], [1, "ap-tab", 3, "click"], [1, "ap-tab__badge"], [1, "ap-view"], [1, "ap-view__title"], [1, "ap-action"], [1, "ap-action__info"], [1, "ap-action__label"], [1, "ap-action__desc"], [1, "ap-action__btn", 3, "click", "disabled"], [1, "ap-result"], [1, "ap-view__desc"], [1, "ap-input-row"], ["type", "email", "placeholder", "user@email.com", 1, "ap-email-input", 3, "ngModelChange", "keydown.enter", "ngModel"], [1, "ap-submit-btn", 3, "click", "disabled"], [1, "ap-reports"], [1, "ap-report"], [1, "ap-report__meta"], [1, "ap-report__group"], [1, "ap-report__time"], [1, "ap-report__text"], [1, "ap-report__reporter"], [1, "ap-report__actions"], [1, "ap-report__btn", "ap-report__btn--dismiss", 3, "click"], [1, "ap-report__btn", "ap-report__btn--delete", 3, "click"]], template: function AdminPanelComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275template(10, AdminPanelComponent_Conditional_10_Template, 12, 3, "div", 5)(11, AdminPanelComponent_Conditional_11_Template, 10, 4, "div", 5)(12, AdminPanelComponent_Conditional_12_Template, 6, 1, "div", 5);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminPanelComponent, { className: "AdminPanelComponent", filePath: "src/app/pages/admin/admin-panel.component.ts", lineNumber: 354 });
})();
export {
  AdminPanelComponent
};
//# sourceMappingURL=chunk-I4D7AQWU.js.map
