...
var mapRoutes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-4VJ2WSWI.js").then((m) => m.MapRootComponent),
    children: [
      {
        path: "",
        pathMatch: "full",
      ...
      },
      {
        ...
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-O6SG36ZF.js").then((m) => m.MapShellComponent),
            children: [
              {
                path: "",
                pathMatch: "full",
...
//# sourceMappingURL=chunk-KYK4DD5H.js.map
