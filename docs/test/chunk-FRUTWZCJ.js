...
function InvoicesAdminComponent_Conditional_10_Conditional_28_For_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(26, InvoicesAdminComponent_Conditional_10_Conditional_28_For_18_ng_template_26_Template, 5, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_15_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InvoicesAdminComponent, { className: "InvoicesAdminComponent", filePath: "src/app/booking/platform/invoices/invoices-admin.component.ts", lineNumber: 26 });
})();
export {
  InvoicesAdminComponent
};
//# sourceMappingURL=chunk-FRUTWZCJ.js.map
