...
var ServicesAdminComponent = class _ServicesAdminComponent {
  ...
  remove(s) {
    return __async(this, null, function* () {
      if (!confirm(`Delete service "${s.name}"? This can't be undone.`))
        return;
      try {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ServicesAdminComponent, { className: "ServicesAdminComponent", filePath: "src/app/booking/platform/services/services-admin.component.ts", lineNumber: 31 });
})();
export {
  ServicesAdminComponent
};
//# sourceMappingURL=chunk-XTLQKDYH.js.map
