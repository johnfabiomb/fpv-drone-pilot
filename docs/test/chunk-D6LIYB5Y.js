...
function BookingInvoiceComponent_Conditional_0_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingInvoiceComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(59);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(60, BookingInvoiceComponent_Conditional_0_Conditional_60_Template, 3, 2, "div", 22);
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(31, 15, ctx_r0.invoice.startAt, "d MMM yyyy, HH:mm"), " \u2013 ", \u0275\u0275pipeBind2(32, 18, ctx_r0.invoice.endAt, "HH:mm"), " ");
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.typeLabel, " paid");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.backLink ? 60 : -1);
  }
}
...
function BookPageComponent_div_5_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function BookPageComponent_div_5_Conditional_13_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r1);
...
function BookPageComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(7, BookPageComponent_div_5_span_7_Template, 2, 0, "span", 6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 11)(9, "a", 12);
    \u0275\u0275text(10, "\u2B07 Download invoice (PDF)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "a", 13);
    \u0275\u0275text(12, "\u{1F5A8} Print invoice");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(13, BookPageComponent_div_5_Conditional_13_Template, 4, 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.showCard && ctx_r1.remainingAmount > 0 ? 13 : -1);
  }
}
function BookPageComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 11)(8, "a", 12);
...
function BookPageComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, BookPageComponent_div_7_ng_container_8_Template, 1, 0, "ng-container", 19);
    \u0275\u0275elementStart(9, "div", 11)(10, "a", 12);
    \u0275\u0275text(11, "\u2B07 Download invoice (PDF)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "a", 13);
    \u0275\u0275text(13, "\u{1F5A8} Print invoice");
    \u0275\u0275elementEnd()()();
    \u0275\u0275element(14, "app-booking-invoice", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    const paidRecords_r3 = \u0275\u0275reference(10);
    \u0275\u0275advance(8);
    \u0275\u0275property("ngTemplateOutlet", paidRecords_r3);
    \u0275\u0275advance(2);
    \u0275\u0275property("href", ctx_r1.invoiceUrl + "&auto=download", \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
    \u0275\u0275property("href", ctx_r1.invoiceUrl + "&auto=print", \u0275\u0275sanitizeUrl);
...
function BookPageComponent_ng_container_8_div_1_div_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const b_r4 = \u0275\u0275nextContext().ngIf;
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(b_r4.location);
  }
}
...
function BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_2_button_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const b_r4 = \u0275\u0275nextContext(3).ngIf;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Remaining ", \u0275\u0275pipeBind4(8, 8, b_r4.price_total - ctx_r1.depositAmount, "EUR", "symbol", "1.2-2"), " due on the day");
  }
}
function BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(12, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_2_button_12_Template, 9, 13, "button", 43);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const b_r4 = \u0275\u0275nextContext(2).ngIf;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(9, 2, b_r4.price_total, "EUR", "symbol", "1.2-2"));
    \u0275\u0275advance(4);
...
function BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_ng_container_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" By confirming, you accept this booking and agree to pay ", \u0275\u0275pipeBind4(7, 3, b_r4.price_total, "EUR", "symbol", "1.2-2"), " by cash, Revolut or bank transfer. ");
  }
}
...
function BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(0, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_ng_template_2_div_0_Template, 3, 0, "div", 49);
...
function BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_ng_container_1_Template, 8, 8, "ng-container", 46)(2, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_ng_template_2_Template, 5, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const askLater_r9 = \u0275\u0275reference(3);
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.payLaterOnly)("ngIfElse", askLater_r9);
  }
}
function BookPageComponent_ng_container_8_div_1_ng_container_25_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 52);
    \u0275\u0275listener("click", function BookPageComponent_ng_container_8_div_1_ng_container_25_button_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext(4);
...
function BookPageComponent_ng_container_8_div_1_ng_container_25_p_5_Template(rf, ctx) {
  if (rf & 1) {
...
function BookPageComponent_ng_container_8_div_1_ng_container_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "div", 34);
    \u0275\u0275template(2, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_2_Template, 15, 7, "ng-container", 6)(3, BookPageComponent_ng_container_8_div_1_ng_container_25_ng_container_3_Template, 4, 2, "ng-container", 6)(4, BookPageComponent_ng_container_8_div_1_ng_container_25_button_4_Template, 2, 0, "button", 35)(5, BookPageComponent_ng_container_8_div_1_ng_container_25_p_5_Template, 2, 1, "p", 36);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function BookPageComponent_ng_container_8_div_1_ng_container_26_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function BookPageComponent_ng_container_8_div_1_ng_container_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, BookPageComponent_ng_container_8_div_1_ng_container_26_ng_container_6_Template, 1, 0, "ng-container", 19);
    \u0275\u0275elementStart(7, "div", 38)(8, "button", 39);
    \u0275\u0275listener("click", function BookPageComponent_ng_container_8_div_1_ng_container_26_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.selectPayment("remainder"));
    });
    \u0275\u0275elementStart(9, "div", 40);
    \u0275\u0275text(10, "Pay remaining balance");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const paidRecords_r3 = \u0275\u0275reference(10);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(5, 6, ctx_r1.totalPaid(), "EUR", "symbol", "1.2-2"), " already paid ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngTemplateOutlet", paidRecords_r3);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(13, 11, ctx_r1.remainingAmount, "EUR", "symbol", "1.2-2"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Completes your booking \u2014 total ", \u0275\u0275pipeBind4(16, 16, b_r4.price_total, "EUR", "symbol", "1.2-2"), "");
    \u0275\u0275advance(5);
    \u0275\u0275property("href", ctx_r1.invoiceUrl + "&auto=download", \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
    \u0275\u0275property("href", ctx_r1.invoiceUrl + "&auto=print", \u0275\u0275sanitizeUrl);
...
function BookPageComponent_ng_container_8_div_1_ng_container_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "div", 34);
    \u0275\u0275elementStart(2, "div", 56)(3, "span");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(7, "currency");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, BookPageComponent_ng_container_8_div_1_ng_container_27_div_8_Template, 4, 0, "div", 58);
    \u0275\u0275element(9, "div", 59);
    \u0275\u0275template(10, BookPageComponent_ng_container_8_div_1_ng_container_27_p_10_Template, 2, 1, "p", 36);
    \u0275\u0275elementStart(11, "div", 60)(12, "button", 61);
    ...
    \u0275\u0275template(15, BookPageComponent_ng_container_8_div_1_ng_container_27_span_15_Template, 1, 0, "span", 63);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "p", 44);
    \u0275\u0275text(18, "\u{1F512} Secure payment via Stripe");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(7, 10, ctx_r1.selectedType() === "deposit" ? ctx_r1.depositAmount : ctx_r1.selectedType() === "remainder" ? ctx_r1.remainingAmount : b_r4.price_total, "EUR", "symbol", "1.2-2"), " ");
    \u0275\u0275advance(2);
...
function BookPageComponent_ng_container_8_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(10, BookPageComponent_ng_container_8_div_1_div_10_Template, 5, 1, "div", 28)(11, BookPageComponent_ng_container_8_div_1_div_11_Template, 5, 1, "div", 28);
    \u0275\u0275elementStart(12, "div", 29)(13, "span", 30);
    \u0275\u0275text(14, "Date");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(24, "currency");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(25, BookPageComponent_ng_container_8_div_1_ng_container_25_Template, 6, 4, "ng-container", 6)(26, BookPageComponent_ng_container_8_div_1_ng_container_26_Template, 24, 21, "ng-container", 6)(27, BookPageComponent_ng_container_8_div_1_ng_container_27_Template, 19, 15, "ng-container", 6);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const b_r4 = ctx.ngIf;
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(b_r4.booking_ref);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", b_r4.location);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", b_r4.description);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind2(17, 10, b_r4.start_at, "d MMM yyyy, HH:mm"), " \u2013 ", \u0275\u0275pipeBind2(18, 13, b_r4.end_at, "HH:mm"), "");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(24, 16, b_r4.price_total, "EUR", "symbol", "1.2-2"));
    \u0275\u0275advance(2);
...
function BookPageComponent_ng_container_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, BookPageComponent_ng_container_8_div_1_Template, 28, 21, "div", 21);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function BookPageComponent_ng_template_9_ul_0_li_1_span_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" \xB7 ", \u0275\u0275pipeBind2(2, 1, p_r13.paid_at, "d MMM yyyy"), "");
  }
}
function BookPageComponent_ng_template_9_ul_0_li_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 70)(1, "span", 71);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 72);
    \u0275\u0275text(5);
    \u0275\u0275template(6, BookPageComponent_ng_template_9_ul_0_li_1_span_6_Template, 3, 4, "span", 6);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(3, 3, p_r13.amount, "EUR", "symbol", "1.2-2"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.methodLabel(p_r13.method), "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", p_r13.paid_at);
  }
}
function BookPageComponent_ng_template_9_ul_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 68);
    \u0275\u0275template(1, BookPageComponent_ng_template_9_ul_0_li_1_Template, 7, 8, "li", 69);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function BookPageComponent_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, BookPageComponent_ng_template_9_ul_0_Template, 2, 1, "ul", 67);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var BookPageComponent = class _BookPageComponent {
  ...
  loadBooking() {
    return __async(this, null, function* () {
      try {
        const { data: link, error } = yield bookingsDb.from("booking_links").select("is_active, expires_at, bookings(booking_ref, title, description, location, start_at, end_at, price_total, price_expenses, allow_card, allow_inperson, deposit_percent, deposit_allowed, status, google_event_id)").eq("token", this.token).single();
        ...
        if (confirmed) {
          if (b.allow_card && this.remainingAmount > 0)
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookPageComponent, selectors: [["app-book-page"]], decls: 11, vars: 8, consts: [["paidRecords", ""], ["askLater", ""], [1, "book-wrap"], ["class", "book-state", 4, "ngIf"], ["class", "book-state book-state--error", 4, "ngIf"], ["class", "paid-page", 4, "ngIf"], [4, "ngIf"], [1, "book-state"], [1, "spinner"], [1, "book-state", "book-state--error"], [1, "state-icon"], [1, "invoice-actions"], ["target", "_blank", "rel", "noopener", 1, "btn", "btn--primary", "invoice-dl", 3, "href"], ["target", "_blank", "rel", "noopener", 1, "btn", "btn--ghost", "invoice-dl", 3, "href"], [1, "pay-optional"], [1, "btn", "btn--primary", 3, "click"], [1, "paid-page"], [1, "paid-banner", "no-print"], [1, "paid-icon"], [4, "ngTemplateOutlet"], [3, "invoice"], ["class", "book-card", 4, "ngIf"], [1, "book-card"], [1, "book-header"], [1, "book-logo"], [1, "book-title"], [1, "book-ref"], [1, "book-details"], ["class", "detail-row", 4, "ngIf"], [1, "detail-row"], [1, "detail-label"], [1, "detail-value"], [1, "detail-value", "detail-value--price"], [1, "detail-value", "text-multiline"], [1, "book-divider"], ["class", "btn btn--ghost book-back", 3, "click", 4, "ngIf"], ["class", "book-error", 4, "ngIf"], [1, "book-section-title"], [1, "payment-options"], [1, "pay-option", 3, "click"], [1, "pay-option__label"], [1, "pay-option__amount"], [1, "pay-option__note"], ["class", "pay-option pay-option--deposit", 3, "click", 4, "ngIf"], [1, "book-secure"], [1, "pay-option", "pay-option--deposit", 3, "click"], [4, "ngIf", "ngIfElse"], [1, "inperson-btn", "inperson-btn--primary", 3, "click", "disabled"], [1, "inperson-note"], ["class", "inperson-divider", 4, "ngIf"], [1, "inperson-btn", 3, "click", "disabled"], [1, "inperson-divider"], [1, "btn", "btn--ghost", "book-back", 3, "click"], [1, "book-error"], [1, "deposit-paid-banner"], [1, "deposit-paid-banner__dot"], [1, "pay-summary"], [1, "pay-summary__amount"], ["class", "pay-loading", 4, "ngIf"], ["id", "payment-element", 1, "payment-element-wrap"], [1, "pay-actions"], [1, "btn", "btn--ghost", 3, "click", "disabled"], [1, "btn", "btn--primary", 3, "click", "disabled"], ["class", "pay-spinner pay-spinner--btn", "aria-hidden", "true", 4, "ngIf"], [1, "pay-loading"], ["aria-hidden", "true", 1, "pay-spinner"], ["aria-hidden", "true", 1, "pay-spinner", "pay-spinner--btn"], ["class", "paid-log", 4, "ngIf"], [1, "paid-log"], ["class", "paid-log__row", 4, "ngFor", "ngForOf"], [1, "paid-log__row"], [1, "paid-log__amount"], [1, "paid-log__meta"]], template: function BookPageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2);
        \u0275\u0275template(1, BookPageComponent_div_1_Template, 4, 0, "div", 3)(2, BookPageComponent_div_2_Template, 7, 0, "div", 4)(3, BookPageComponent_div_3_Template, 7, 0, "div", 4)(4, BookPageComponent_div_4_Template, 7, 0, "div", 4)(5, BookPageComponent_div_5_Template, 14, 4, "div", 3)(6, BookPageComponent_div_6_Template, 12, 2, "div", 3)(7, BookPageComponent_div_7_Template, 15, 4, "div", 5)(8, BookPageComponent_ng_container_8_Template, 2, 1, "ng-container", 6)(9, BookPageComponent_ng_template_9_Template, 1, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookPageComponent, { className: "BookPageComponent", filePath: "src/app/booking/public/book-page/book-page.component.ts", lineNumber: 53 });
})();
export {
  BookPageComponent
};
//# sourceMappingURL=chunk-D6LIYB5Y.js.map
