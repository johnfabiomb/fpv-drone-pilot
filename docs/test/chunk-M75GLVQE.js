...
function MaltaMapComponent_app_provider_detail_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("bookRequested", function MaltaMapComponent_app_provider_detail_3_Template_app_provider_detail_bookRequested_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
var MaltaMapComponent = class _MaltaMapComponent {
  ...
  static {
    ...
    }, decls: 4, vars: 6, consts: [[3, "closeRequested", "dragStart", "dragMove", "dragEnd", "toggleCollapse", "bodyDragStart", "bodyDragMove", "bodyDragEnd", "title", "minimized"], ["panelActions", "", 3, "url", "shareTitle"], [3, "location", "userLat", "userLon", "close", "explore", "navRequested", "providerSelected", 4, "ngIf"], [3, "provider", "bookRequested", 4, "ngIf"], [3, "close", "explore", "navRequested", "providerSelected", "location", "userLat", "userLon"], [3, "bookRequested", "provider"]], template: function MaltaMapComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MaltaMapComponent, { className: "MaltaMapComponent", filePath: "src/app/platform/malta-map/malta-map.component.ts", lineNumber: 24 });
})();
export {
  MaltaMapComponent
};
//# sourceMappingURL=chunk-M75GLVQE.js.map
