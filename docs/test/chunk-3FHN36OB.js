...
var mapRoutes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-ZNDCS255.js").then((m) => m.MapRootComponent),
    children: [
      {
        path: "",
        pathMatch: "full",
      ...
      },
      {
        ...
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-3OYPTMJV.js").then((m) => m.MapShellComponent),
            children: [
              {
                path: "",
                pathMatch: "full",
...
//# sourceMappingURL=chunk-3FHN36OB.js.map
