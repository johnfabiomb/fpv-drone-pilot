...
function FilterBarComponent_div_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("active", ctx_r2.isActive(f_r2.id));
    \u0275\u0275advance();
...
var FilterBarComponent = class _FilterBarComponent {
  constructor() {
    ...
    this.filters = [
      ...
      { id: "easy", label: "Easy Access", emoji: "\u{1F6B6}" },
      { id: "hard", label: "Hard Access", emoji: "\u{1F97E}" }
    ];
  }
  get isAll() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FilterBarComponent, selectors: [["app-filter-bar"]], outputs: { filterChange: "filterChange" }, decls: 7, vars: 8, consts: [[1, "filter-bar"], [1, "chip", 3, "click"], ["class", "emoji", 4, "ngIf"], [1, "label"], ["class", "chip-x", 4, "ngIf"], ["class", "chip", 3, "active", "click", 4, "ngFor", "ngForOf"], [1, "emoji"], [1, "chip-x"]], template: function FilterBarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(6, FilterBarComponent_div_6_Template, 5, 5, "div", 5);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FilterBarComponent, { className: "FilterBarComponent", filePath: "src/app/components/filter-bar/filter-bar.component.ts", lineNumber: 17 });
})();
...
function FooterComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(22, "Contact");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 21)(24, "a", 22);
    \u0275\u0275text(25, "creator@johnfabiomb.com");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "div", 23);
    \u0275\u0275text(27, "For privacy, cookie, or sponsorship questions, use the linked pages above or send a message.");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 24)(29, "a", 25);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(30, "svg", 26);
    \u0275\u0275element(31, "path", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275text(32, " @johnfabiomb ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(33, "a", 28);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(34, "svg", 26);
    \u0275\u0275element(35, "path", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275text(36, " John Monta\xF1o ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(37, "a", 30);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(38, "svg", 26);
    \u0275\u0275element(39, "path", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275text(40, " @johnfabiomb ");
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["app-footer"]], hostBindings: function FooterComponent_HostBindings(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275listener("click", function FooterComponent_click_HostBindingHandler() {
          return ctx.closeAbout();
        }, false, \u0275\u0275resolveDocument);
      }
    }, decls: 14, vars: 2, consts: [[1, "bottom-bar"], ["class", "route-btn", "routerLink", "/malta/plan", 4, "ngIf"], ["routerLink", "/malta/list", 1, "list-btn"], [1, "profile-wrap", 3, "click"], ["class", "about-popup", 3, "click", 4, "ngIf"], [1, "text"], [1, "dev"], [1, "name"], [1, "title"], ["src", "/assets/images/profile.webp", "width", "36", "height", "36", "alt", "John Monta\xF1o", 1, "profile-picture"], ["routerLink", "/malta/plan", 1, "route-btn"], [1, "about-popup", 3, "click"], ["src", "/assets/images/profile.webp", "alt", "John Monta\xF1o", 1, "about-photo"], [1, "about-name"], [1, "about-tags"], [1, "about-divider"], [1, "about-policies"], ["routerLink", "/about"], ["routerLink", "/privacy"], ["routerLink", "/cookies"], ["routerLink", "/contact"], [1, "about-contact"], ["href", "mailto:creator@johnfabiomb.com"], [1, "about-contact-note"], [1, "about-socials"], ["href", "https://www.instagram.com/johnfabiomb/", "target", "_blank", "rel", "noopener", 1, "about-social"], ["width", "17", "height", "17", "viewBox", "0 0 24 24", "fill", "currentColor"], ["d", "M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"], ["href", "https://www.facebook.com/johnfabiomb/", "target", "_blank", "rel", "noopener", 1, "about-social"], ["d", "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"], ["href", "https://www.tiktok.com/@johnfabiomb", "target", "_blank", "rel", "noopener", 1, "about-social"], ["d", "M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z"], [1, "about-version"]], template: function FooterComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275listener("click", function FooterComponent_Template_div_click_4_listener($event) {
          return ctx.toggleAbout($event);
        });
        \u0275\u0275template(5, FooterComponent_div_5_Template, 43, 1, "div", 4);
        \u0275\u0275elementStart(6, "div", 5)(7, "span", 6);
        \u0275\u0275text(8, "Designed & developed by");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(9, "span", 7);
        \u0275\u0275text(10, "John Monta\xF1o");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(11, "span", 8);
        \u0275\u0275text(12, "Explorer \xB7 Creator \xB7 Developer");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(13, "img", 9);
        \u0275\u0275elementEnd()();
      }
...
var MapComponent = class _MapComponent {
  ...
  rebuildProviderLayer() {
    ...
    for (const p of this._providerPins) {
      ...
      if (this.providerCanvasCache.has(p.id))
        continue;
      const label = p.mapLabel ?? "\u{1F3F7}\uFE0F Deal";
      if (p.coverImage) {
        const img = new Image();
        img.onload = () => {
  ...
  buildPillPin(pin, label, large = false) {
...
function MapShellComponent_app_nav_interstitial_0_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "app-coupon-reminder", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function MapShellComponent_app_nav_interstitial_0_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275template(1, MapShellComponent_app_nav_interstitial_0_div_2_p_1_Template, 2, 1, "p", 19);
    \u0275\u0275elementStart(2, "app-provider-card", 20);
...
function MapShellComponent_app_nav_interstitial_0_app_provider_card_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-provider-card", 22);
...
function MapShellComponent_app_nav_interstitial_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-nav-interstitial", 14);
    ...
    \u0275\u0275template(1, MapShellComponent_app_nav_interstitial_0_div_1_Template, 2, 1, "div", 15)(2, MapShellComponent_app_nav_interstitial_0_div_2_Template, 3, 2, "div", 15)(3, MapShellComponent_app_nav_interstitial_0_app_provider_card_3_Template, 1, 1, "app-provider-card", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function MapShellComponent_app_filter_bar_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-filter-bar", 23);
...
function MapShellComponent_div_9_button_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, MapShellComponent_div_9_button_3_span_1_Template, 2, 1, "span", 31);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function MapShellComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, " All ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, MapShellComponent_div_9_button_3_Template, 3, 6, "button", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function MapShellComponent_button_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 34);
    \u0275\u0275listener("click", function MapShellComponent_button_13_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
...
var MapShellComponent = class _MapShellComponent {
  ...
  static {
    ...
    }, features: [\u0275\u0275ProvidersFeature([MapBridgeService])], decls: 16, vars: 13, consts: [["mapComp", ""], ["panelWrap", ""], [3, "url", "duration", "buttonLabel", "openNewTab", "closed", 4, "ngIf"], [1, "map-layout"], [1, "map-layout__main"], [1, "map-layout__map"], [3, "filterChange", 4, "ngIf"], [3, "locationSelected", "providerPinSelected", "mapTapped", "gpsCoord", "activeFilters", "providerPins", "selectedLocation", "fitPoint"], ["class", "floating-back-btn", 3, "floating-back-btn--accent", "click", 4, "ngIf"], ["class", "show-panel-btn", 3, "show-panel-btn--primary", "click", 4, "ngIf"], ["class", "floating-route-tabs", 4, "ngIf"], ["class", "offline-pill", 4, "ngIf"], [1, "map-layout__panel"], ["class", "collapse-btn", "title", "Fullscreen map", 3, "click", 4, "ngIf"], [3, "closed", "url", "duration", "buttonLabel", "openNewTab"], ["slot-top", "", 4, "ngIf"], ["slot-bottom", "", 3, "provider", "selected", 4, "ngIf"], ["slot-top", ""], [3, "provider"], ["class", "interstitial-near-label", 4, "ngIf"], [3, "selected", "provider"], [1, "interstitial-near-label"], ["slot-bottom", "", 3, "selected", "provider"], [3, "filterChange"], [1, "floating-back-btn", 3, "click"], [1, "fa", "fa-chevron-left"], [1, "show-panel-btn", 3, "click"], [1, "fa", 3, "ngClass"], [1, "floating-route-tabs"], [1, "route-tab", 3, "click"], ["class", "route-tab", 3, "active", "--tab-active-color", "click", 4, "ngFor", "ngForOf"], [4, "ngIf"], [1, "offline-pill"], [1, "offline-dot"], ["title", "Fullscreen map", 1, "collapse-btn", 3, "click"], [1, "fa", "fa-chevron-right"]], template: function MapShellComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(11, "div", 12, 1);
        \u0275\u0275template(13, MapShellComponent_button_13_Template, 2, 0, "button", 13);
