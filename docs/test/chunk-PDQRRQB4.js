...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LocationDetailComponent, { className: "LocationDetailComponent", filePath: "src/app/components/location-detail/location-detail.component.ts", lineNumber: 22 });
})();
...
function LocationPageComponent_app_location_detail_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("location", ctx_r0.location)("userLat", ctx_r0.userLat)("userLon", ctx_r0.userLon);
  }
}
var LocationPageComponent = class _LocationPageComponent {
  ...
  syncInterstitialProviders() {
    ...
    const loc = this.location;
    const all = providers;
    const mapProviders = all.filter((p) => p.showOnMap && p.lat && p.lon);
    const nearSpot = all.filter((p) => p.nearLocationIds?.includes(loc.id) || p.lat && p.lon && haversineKm(loc.lat, loc.lon, p.lat, p.lon) <= this.NEAR_LOCATION_KM).sort((a, b) => {
    ...
    const pinIds = new Set(mapProviders.map((p) => p.id));
    const extra = nearSpot.filter((p) => p.lat && p.lon && !pinIds.has(p.id));
    this.bridge.providerPins.set([...mapProviders, ...extra]);
  }
  static {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LocationPageComponent, selectors: [["app-location-page"]], decls: 3, vars: 4, consts: [[3, "closeRequested", "dragStart", "dragMove", "dragEnd", "toggleCollapse", "bodyDragStart", "bodyDragMove", "bodyDragEnd", "title", "minimized"], ["panelActions", "", 3, "url", "shareTitle", 4, "ngIf"], [3, "location", "userLat", "userLon", "close", "explore", "navRequested", "providerSelected", 4, "ngIf"], ["panelActions", "", 3, "url", "shareTitle"], [3, "close", "explore", "navRequested", "providerSelected", "location", "userLat", "userLon"]], template: function LocationPageComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        })("toggleCollapse", function LocationPageComponent_Template_app_panel_shell_toggleCollapse_0_listener() {
        ...
        \u0275\u0275template(1, LocationPageComponent_app_share_btn_1_Template, 1, 2, "app-share-btn", 1)(2, LocationPageComponent_app_location_detail_2_Template, 1, 3, "app-location-detail", 2);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_0_0;
        \u0275\u0275property("title", (tmp_0_0 = ctx.location == null ? null : ctx.location.title) !== null && tmp_0_0 !== void 0 ? tmp_0_0 : "")("minimized", ctx.bridge.panel.minimized());
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LocationPageComponent, { className: "LocationPageComponent", filePath: "src/app/platform/location-page/location-page.component.ts", lineNumber: 56 });
})();
export {
  LocationPageComponent
};
//# sourceMappingURL=chunk-PDQRRQB4.js.map
