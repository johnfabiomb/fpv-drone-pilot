...
function GroupMembersModalComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function GroupMembersModalComponent_div_11_Template_div_click_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.bulkSelectMode() && m_r4.uid !== (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.id) && m_r4.role !== "leader" ? ctx_r1.toggleBulkSelect(m_r4.uid) : null);
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("gd-member--selectable", ctx_r1.bulkSelectMode() && ctx_r1.isBulkSelected(m_r4.uid) !== void 0 && m_r4.uid !== (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.id) && m_r4.role !== "leader")("gd-member--selected", ctx_r1.isBulkSelected(m_r4.uid));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.bulkSelectMode() && m_r4.uid !== (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.id) && m_r4.role !== "leader");
    \u0275\u0275advance();
