...
var PaymentSuccessComponent = class _PaymentSuccessComponent {
  ...
  buildReceiptCanvas() {
    ...
    ctx.fillText("EXPLORER \xB7 CONTENT CREATOR", CX, 226);
    ctx.beginPath();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PaymentSuccessComponent, { className: "PaymentSuccessComponent", filePath: "src/app/pages/payment-success/payment-success.component.ts", lineNumber: 15 });
})();
export {
  PaymentSuccessComponent
};
//# sourceMappingURL=chunk-OBILENSG.js.map
