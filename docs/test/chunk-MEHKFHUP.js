...
var mapRoutes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-EOFS7UWX.js").then((m) => m.MapRootComponent),
    children: [
      {
        path: "",
        pathMatch: "full",
      ...
      },
      {
        ...
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-T5MPJJPM.js").then((m) => m.MapShellComponent),
            children: [
              {
                path: "",
                pathMatch: "full",
                loadComponent: () => import("./chunk-7DQJCNNK.js").then((mod) => mod.MapExploreComponent)
              },
              {
                path: "list",
                loadComponent: () => import("./chunk-Y5MQWJFR.js").then((m) => m.LocationListComponent)
              },
              {
                path: "deals",
              ...
              {
                path: "providers/:id",
                loadComponent: () => import("./chunk-YAGEBOEV.js").then((m) => m.ProviderPageComponent)
              },
              {
                path: "experiences/:id",
              ...
              {
                path: "locations/:slug",
                loadComponent: () => import("./chunk-I25NSOU7.js").then((m) => m.LocationPageComponent)
              },
              {
                path: "saved",
                loadComponent: () => import("./chunk-JE2YUE7L.js").then((m) => m.SavedPlacesComponent)
              },
              {
                path: "admin",
                canMatch: [() => inject(UserDataService).isAdmin()],
                loadComponent: () => import("./chunk-47MSWIAR.js").then((m) => m.AdminPanelComponent)
              },
              {
                path: "groups",
                canMatch: [() => FEATURES.GROUPS],
                loadComponent: () => import("./chunk-EL4YV7ZI.js").then((m) => m.ExploreTogetherComponent)
              },
              {
                path: "groups/:id",
                canMatch: [() => FEATURES.GROUPS],
                loadComponent: () => import("./chunk-TOHHSJVN.js").then((m) => m.GroupDetailComponent)
              },
              {
                path: "notifications",
          ...
          },
          {
            ...
            loadComponent: () => import("./chunk-BHCZMWAI.js").then((m) => m.RouteBuilderComponent)
          }
        ]
      },
      {
...
//# sourceMappingURL=chunk-MEHKFHUP.js.map
