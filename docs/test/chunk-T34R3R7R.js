...
function ExploreTogetherComponent_div_11_ul_16_li_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 40);
    \u0275\u0275listener("click", function ExploreTogetherComponent_div_11_ul_16_li_1_Template_li_click_0_listener() {
...
function ExploreTogetherComponent_div_11_ul_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 38);
    \u0275\u0275template(1, ExploreTogetherComponent_div_11_ul_16_li_1_Template, 2, 1, "li", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ExploreTogetherComponent_div_11_span_17_Template(rf, ctx) {
  if (rf & 1) {
...
function ExploreTogetherComponent_div_11_p_49_Template(rf, ctx) {
  if (rf & 1) {
...
function ExploreTogetherComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ExploreTogetherComponent_div_11_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExploreTogetherComponent_div_11_Template_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 22)(13, "label");
    \u0275\u0275text(14, "Spot");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "input", 23);
    \u0275\u0275twoWayListener("ngModelChange", function ExploreTogetherComponent_div_11_Template_input_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.formSpotSearch, $event) || (ctx_r1.formSpotSearch = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function ExploreTogetherComponent_div_11_Template_input_input_15_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSpotSearchInput());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(16, ExploreTogetherComponent_div_11_ul_16_Template, 2, 1, "ul", 24)(17, ExploreTogetherComponent_div_11_span_17_Template, 4, 1, "span", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 26)(19, "div", 20)(20, "label");
    \u0275\u0275text(21, "Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "input", 27);
    \u0275\u0275twoWayListener("ngModelChange", function ExploreTogetherComponent_div_11_Template_input_ngModelChange_22_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExploreTogetherComponent_div_11_Template_input_ngModelChange_26_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ExploreTogetherComponent_div_11_Template_span_click_31_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ExploreTogetherComponent_div_11_Template_span_click_33_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ExploreTogetherComponent_div_11_Template_span_click_35_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementStart(40, "span", 31);
    \u0275\u0275text(41, "(optional)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(42, "textarea", 32);
    \u0275\u0275twoWayListener("ngModelChange", function ExploreTogetherComponent_div_11_Template_textarea_ngModelChange_42_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExploreTogetherComponent_div_11_Template_input_ngModelChange_48_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(49, ExploreTogetherComponent_div_11_p_49_Template, 2, 1, "p", 34);
    \u0275\u0275elementStart(50, "div", 35)(51, "button", 36);
    \u0275\u0275listener("click", function ExploreTogetherComponent_div_11_Template_button_click_51_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.cancelCreate());
    });
    ...
    \u0275\u0275listener("click", function ExploreTogetherComponent_div_11_Template_button_click_53_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function ExploreTogetherComponent_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "span", 46)(2, "span", 46)(3, "span", 46);
    \u0275\u0275elementEnd();
  }
}
function ExploreTogetherComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ExploreTogetherComponent_div_13_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
...
function ExploreTogetherComponent_div_14_app_group_card_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-group-card", 55);
  }
  if (rf & 2) {
...
function ExploreTogetherComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 52)(1, "div", 53);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ExploreTogetherComponent_div_14_app_group_card_3_Template, 1, 1, "app-group-card", 54);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreTogetherComponent, selectors: [["app-explore-together"]], hostBindings: function ExploreTogetherComponent_HostBindings(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementStart(1, "div", 1)(2, "div", 2)(3, "div", 3)(4, "p", 4);
        \u0275\u0275text(5, "Find fellow explorers for Malta's best spots \u2014 join a group or start your own.");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(6, "button", 5);
        \u0275\u0275listener("click", function ExploreTogetherComponent_Template_button_click_6_listener() {
        ...
        \u0275\u0275text(10, " New group ");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(11, ExploreTogetherComponent_div_11_Template, 55, 18, "div", 9)(12, ExploreTogetherComponent_div_12_Template, 4, 0, "div", 10)(13, ExploreTogetherComponent_div_13_Template, 12, 0, "div", 11)(14, ExploreTogetherComponent_div_14_Template, 4, 3, "div", 12);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(11);
...
//# sourceMappingURL=chunk-T34R3R7R.js.map
