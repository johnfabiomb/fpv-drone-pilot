...
function AvailabilityCalendarComponent_Conditional_17_Conditional_6_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("slot--busy", !s_r7.available)("slot--unstartable", s_r7.unstartable)("slot--range", s_r7.inRange)("slot--start", s_r7.isStart)("slot--end", s_r7.isEnd);
...
function AvailabilityCalendarComponent_Conditional_17_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, AvailabilityCalendarComponent_Conditional_17_Conditional_6_For_2_Template, 4, 13, "button", 20, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
...
var AvailabilityCalendarComponent = class _AvailabilityCalendarComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AvailabilityCalendarComponent, selectors: [["app-availability-calendar"]], inputs: { monthLabel: [1, "monthLabel"], canGoPrev: [1, "canGoPrev"], cells: [1, "cells"], selectedDate: [1, "selectedDate"], loading: [1, "loading"], error: [1, "error"], dayLabel: [1, "dayLabel"], slots: [1, "slots"], timeLabel: [1, "timeLabel"], timeHint: [1, "timeHint"], emptyText: [1, "emptyText"], showBusyReason: [1, "showBusyReason"], hasSelection: [1, "hasSelection"] }, outputs: { prevMonth: "prevMonth", nextMonth: "nextMonth", daySelected: "daySelected", slotSelected: "slotSelected", clearSelection: "clearSelection" }, decls: 18, vars: 6, consts: [[1, "step"], [1, "step__label"], [1, "cal"], [1, "cal__nav"], ["type", "button", "aria-label", "Previous month", 1, "cal__arrow", 3, "click", "disabled"], [1, "cal__month"], ["type", "button", "aria-label", "Next month", 1, "cal__arrow", 3, "click"], [1, "cal__dow"], [1, "cal__loading"], [1, "cal__grid"], [1, "cal__error"], [1, "cell", "cell--blank"], ["type", "button", 1, "cell", 3, "cell--available", "cell--selected", "disabled"], ["type", "button", 1, "cell", 3, "click", "disabled"], [1, "cell__dot"], [1, "step__hint"], ["type", "button", 1, "step__clear"], [1, "cal__empty"], [1, "slots"], ["type", "button", 1, "step__clear", 3, "click"], ["type", "button", 1, "slot", 3, "slot--busy", "slot--unstartable", "slot--range", "slot--start", "slot--end", "disabled"], ["type", "button", 1, "slot", 3, "click", "disabled"], [1, "slot__time"], [1, "slot__reason"]], template: function AvailabilityCalendarComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "section", 0)(1, "h2", 1);
        \u0275\u0275text(2);
        \u0275\u0275elementEnd();
...
//# sourceMappingURL=chunk-63GOS5RZ.js.map
