...
function InvoicesAdminComponent_Conditional_10_Conditional_28_For_21_ng_template_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function InvoicesAdminComponent_Conditional_10_Conditional_28_For_21_ng_template_26_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r8);
    ...
    \u0275\u0275listener("click", function InvoicesAdminComponent_Conditional_10_Conditional_28_For_21_ng_template_26_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r8);
      const b_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function InvoicesAdminComponent_Conditional_10_Conditional_28_For_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 25);
    \u0275\u0275listener("click", function InvoicesAdminComponent_Conditional_10_Conditional_28_For_21_Template_tr_click_0_listener() {
    ...
    \u0275\u0275pipe(16, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "td", 32)(18, "span", 33);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "td", 34)(21, "button", 35);
    \u0275\u0275listener("click", function InvoicesAdminComponent_Conditional_10_Conditional_28_For_21_Template_button_click_21_listener($event) {
      \u0275\u0275restoreView(_r6);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(22, "svg", 36);
    \u0275\u0275element(23, "circle", 37)(24, "circle", 38)(25, "circle", 39);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(26, InvoicesAdminComponent_Conditional_10_Conditional_28_For_21_ng_template_26_Template, 7, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_15_0;
...
function InvoicesAdminComponent_Conditional_10_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 19)(1, "table", 22)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5, "Invoice");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    \u0275\u0275text(7, "Date");
    ...
    \u0275\u0275repeaterCreate(20, InvoicesAdminComponent_Conditional_10_Conditional_28_For_21_Template, 28, 34, "tr", 24, _forTrack1);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function InvoicesAdminComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(27, InvoicesAdminComponent_Conditional_10_Conditional_27_Template, 2, 0, "p", 6)(28, InvoicesAdminComponent_Conditional_10_Conditional_28_Template, 22, 0, "div", 19);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
...
//# sourceMappingURL=chunk-244AQOIW.js.map
