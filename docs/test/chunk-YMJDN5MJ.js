...
} from "./chunk-CN4VODUK.js";
import {
  isDiscountValid,
  resolveProviderColor
} from "./chunk-U7MOBCX6.js";
import {
  FILTER_OPTIONS,
  matchesFilter
    ...
    !function(t, i) {
        ...
        !function t3(n2, r3, e3, a3, h3) {
          for (; a3 > e3; ) {
            ...
            for (i(n2, e3, r3), h3(n2[a3], p5) > 0 && i(n2, e3, a3); d2 < x; ) {
              for (i(n2, d2, x), d2++, x--; h3(n2[d2], p5) < 0; ) d2++;
              for (; h3(n2[x], p5) > 0; ) x--;
            }
      ...
      return r.prototype.all = function() {
        ...
        if (this.data.children.length) {
          if (this.data.height === n2.height) this._splitRoot(this.data, n2);
          else {
...
function FilterBarComponent_span_2_Template(rf, ctx) {
  if (rf & 1) {
...
function FilterBarComponent_span_5_Template(rf, ctx) {
  if (rf & 1) {
...
function FilterBarComponent_div_6_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 6);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(f_r2.emoji);
  }
}
function FilterBarComponent_div_6_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 7);
    \u0275\u0275text(1, "\u2715");
    \u0275\u0275elementEnd();
...
function FilterBarComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 1);
    \u0275\u0275listener("click", function FilterBarComponent_div_6_Template_div_click_0_listener() {
      const f_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggle(f_r2.id));
    });
    \u0275\u0275template(1, FilterBarComponent_div_6_span_1_Template, 2, 1, "span", 2);
    \u0275\u0275elementStart(2, "span", 3);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, FilterBarComponent_div_6_span_4_Template, 2, 0, "span", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const f_r2 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("chip--deals", f_r2.id === "deals")("active", ctx_r2.isActive(f_r2.id));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r2.isActive(f_r2.id));
    \u0275\u0275advance(2);
...
var FilterBarComponent = class _FilterBarComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FilterBarComponent, selectors: [["app-filter-bar"]], outputs: { filterChange: "filterChange" }, decls: 7, vars: 8, consts: [[1, "filter-bar"], [1, "chip", 3, "click"], ["class", "emoji", 4, "ngIf"], [1, "label"], ["class", "chip-x", 4, "ngIf"], ["class", "chip", 3, "chip--deals", "active", "click", 4, "ngFor", "ngForOf"], [1, "emoji"], [1, "chip-x"]], template: function FilterBarComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1);
        \u0275\u0275listener("click", function FilterBarComponent_Template_div_click_1_listener() {
          return ctx.selectAll();
        });
        \u0275\u0275template(2, FilterBarComponent_span_2_Template, 2, 0, "span", 2);
        \u0275\u0275elementStart(3, "span", 3);
        \u0275\u0275text(4);
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, FilterBarComponent_span_5_Template, 2, 0, "span", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275template(6, FilterBarComponent_div_6_Template, 5, 7, "div", 5);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
        \u0275\u0275classProp("active", ctx.isAll)("clear", !ctx.isAll);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.isAll);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(ctx.isAll ? "All" : "Clear");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.isAll);
        \u0275\u0275advance();
        \u0275\u0275property("ngForOf", ctx.filters);
      }
    }, dependencies: [NgIf, NgForOf], styles: ["\n\n.filter-bar[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 6px;\n  padding: 8px 10px;\n  overflow-x: auto;\n  scrollbar-width: none;\n  background: var(--color-bg, #fff);\n  border-radius: var(--radius-xl, 12px);\n  box-shadow: 0 2px 16px rgba(0, 0, 0, 0.1);\n}\n.filter-bar[_ngcontent-%COMP%]::-webkit-scrollbar {\n  display: none;\n}\n.filter-bar[_ngcontent-%COMP%]   .chip[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 5px;\n  padding: 6px 13px;\n  border-radius: var(--radius-lg, 10px);\n  font-size: 13px;\n}\n.filter-bar[_ngcontent-%COMP%]   .chip.active[_ngcontent-%COMP%] {\n  background: var(--color-primary, #F4A922);\n  border-color: var(--color-primary, #F4A922);\n  box-shadow: 0 2px 8px var(--color-primary-shadow, rgba(244, 169, 34, 0.3));\n}\n.filter-bar[_ngcontent-%COMP%]   .chip.clear[_ngcontent-%COMP%] {\n  border-color: var(--color-primary, #F4A922);\n  color: var(--color-primary, #F4A922);\n  background: rgba(244, 169, 34, 0.07);\n  font-weight: 600;\n}\n.filter-bar[_ngcontent-%COMP%]   .chip[_ngcontent-%COMP%]   .emoji[_ngcontent-%COMP%] {\n  font-size: 14px;\n  line-height: 1;\n}\n.filter-bar[_ngcontent-%COMP%]   .chip[_ngcontent-%COMP%]   .chip-x[_ngcontent-%COMP%] {\n  font-size: 12px;\n  line-height: 1;\n  opacity: 0.7;\n}\n/*# sourceMappingURL=filter-bar.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FilterBarComponent, { className: "FilterBarComponent", filePath: "src/app/components/filter-bar/filter-bar.component.ts", lineNumber: 13 });
})();
...
function FooterComponent_a_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, "\u{1F5FA}\uFE0F Build My Route");
    \u0275\u0275elementEnd();
  }
}
function FooterComponent_div_5_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 13);
    \u0275\u0275listener("click", function FooterComponent_div_5_div_1_Template_div_click_0_listener($event) {
      \u0275\u0275restoreView(_r3);
    ...
    \u0275\u0275listener("click", function FooterComponent_div_5_div_1_Template_a_click_8_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.showProfile = false);
    });
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275element(13, "polyline", 22);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275element(14, "div", 23);
    \u0275\u0275elementStart(15, "div", 24)(16, "button", 25);
    \u0275\u0275listener("click", function FooterComponent_div_5_div_1_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("src", (tmp_2_0 = ctx_r1.authService.user()) == null ? null : tmp_2_0.photoURL, \u0275\u0275sanitizeUrl)("alt", ((tmp_3_0 = ctx_r1.authService.user()) == null ? null : tmp_3_0.displayName) || "User");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((tmp_4_0 = ctx_r1.authService.user()) == null ? null : tmp_4_0.displayName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((tmp_5_0 = ctx_r1.authService.user()) == null ? null : tmp_5_0.email);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.levelLabel);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate2(" ", ctx_r1.userDataService.savedLocations().size, " saved place", ctx_r1.userDataService.savedLocations().size === 1 ? "" : "s", " ");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1("v", ctx_r1.version, "");
  }
}
function FooterComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 7);
    \u0275\u0275listener("click", function FooterComponent_div_5_Template_div_click_0_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleProfile($event));
    });
    \u0275\u0275template(1, FooterComponent_div_5_div_1_Template, 20, 8, "div", 8);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.showProfile);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate((tmp_2_0 = ctx_r1.authService.user()) == null ? null : tmp_2_0.displayName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.levelLabel);
    \u0275\u0275advance();
    \u0275\u0275property("src", (tmp_4_0 = ctx_r1.authService.user()) == null ? null : tmp_4_0.photoURL, \u0275\u0275sanitizeUrl)("alt", ((tmp_5_0 = ctx_r1.authService.user()) == null ? null : tmp_5_0.displayName) || "User");
  }
}
function FooterComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function FooterComponent_div_6_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(5, "Save places & unlock deals");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 28);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(7, "svg", 29);
    \u0275\u0275element(8, "path", 30)(9, "circle", 31);
    \u0275\u0275elementEnd()()();
  }
}
var FooterComponent = class _FooterComponent {
  ...
  get levelLabel() {
    return `Explorer \xB7 Level ${this.userDataService.level()}`;
  }
  toggleProfile(e) {
    e.stopPropagation();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["app-footer"]], hostBindings: function FooterComponent_HostBindings(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275listener("click", function FooterComponent_click_HostBindingHandler() {
          return ctx.closePopups();
        }, false, \u0275\u0275resolveDocument);
      }
    }, decls: 7, vars: 3, consts: [[1, "bottom-bar"], ["class", "route-btn", "routerLink", "/malta/plan", 4, "ngIf"], ["routerLink", "/malta/list", 1, "list-btn"], [1, "footer-right"], ["class", "profile-wrap", 3, "click", 4, "ngIf"], ["class", "profile-wrap profile-wrap--guest", 3, "click", 4, "ngIf"], ["routerLink", "/malta/plan", 1, "route-btn"], [1, "profile-wrap", 3, "click"], ["class", "about-popup", 3, "click", 4, "ngIf"], [1, "text"], [1, "name"], [1, "title"], ["width", "36", "height", "36", "referrerpolicy", "no-referrer", 1, "profile-picture", 3, "src", "alt"], [1, "about-popup", 3, "click"], ["referrerpolicy", "no-referrer", 1, "about-photo", "user-photo", 3, "src", "alt"], [1, "about-name"], [1, "about-email"], [1, "level-badge"], ["routerLink", "/malta/saved", 1, "saved-count", 3, "click"], ["width", "13", "height", "13", "viewBox", "0 0 24 24", "fill", "currentColor", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"], ["width", "12", "height", "12", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.5", "stroke-linecap", "round", "stroke-linejoin", "round", 2, "margin-left", "auto", "color", "#d1d5db"], ["points", "9 18 15 12 9 6"], [1, "about-divider"], [1, "about-policies"], [1, "signout-btn", 3, "click"], [1, "about-version"], [1, "profile-wrap", "profile-wrap--guest", 3, "click"], [1, "profile-picture", "profile-picture--guest"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.8", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"], ["cx", "12", "cy", "7", "r", "4"]], template: function FooterComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275template(1, FooterComponent_a_1_Template, 2, 0, "a", 1);
        \u0275\u0275elementStart(2, "a", 2);
        \u0275\u0275text(3, "\u{1F4CD} Browse All");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(4, "div", 3);
        \u0275\u0275template(5, FooterComponent_div_5_Template, 8, 5, "div", 4)(6, FooterComponent_div_6_Template, 10, 0, "div", 5);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.features.ROUTE_BUILDER);
        \u0275\u0275advance(4);
        \u0275\u0275property("ngIf", ctx.authService.isLoggedIn());
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.authService.isLoggedIn());
      }
    }, dependencies: [NgIf, RouterLink], styles: ['\n\n.bottom-bar[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 64px;\n  padding: 0 16px;\n  box-sizing: border-box;\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  background: rgba(255, 255, 255, 0.92);\n  backdrop-filter: blur(14px);\n  -webkit-backdrop-filter: blur(14px);\n  border-top: 1px solid rgba(0, 0, 0, 0.08);\n  position: relative;\n  z-index: 400;\n}\n.route-btn[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  gap: 6px;\n  background: #F4A922;\n  color: #fff;\n  text-decoration: none;\n  border-radius: 10px;\n  padding: 10px 18px;\n  font-weight: 700;\n  font-size: 14px;\n  box-shadow: 0 2px 10px rgba(244, 169, 34, 0.35);\n  white-space: nowrap;\n  transition: box-shadow 0.15s, opacity 0.15s;\n}\n.route-btn[_ngcontent-%COMP%]:hover {\n  opacity: 0.9;\n  box-shadow: 0 4px 16px rgba(244, 169, 34, 0.45);\n}\n.list-btn[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  gap: 5px;\n  background: #f9fafb;\n  color: #374151;\n  text-decoration: none;\n  border-radius: 10px;\n  padding: 8px 14px;\n  font-weight: 600;\n  font-size: 13px;\n  border: 1px solid #e5e7eb;\n  white-space: nowrap;\n  transition: background 0.15s, box-shadow 0.15s;\n}\n.list-btn[_ngcontent-%COMP%]:hover {\n  background: #f3f4f6;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);\n}\n.about-wrap[_ngcontent-%COMP%] {\n  position: relative;\n  cursor: pointer;\n  -webkit-user-select: none;\n  user-select: none;\n  margin-left: 10px;\n}\n.about-trigger[_ngcontent-%COMP%] {\n  width: 32px;\n  height: 32px;\n  border-radius: 8px;\n  object-fit: cover;\n  object-position: center top;\n  border: 2px solid #e5e7eb;\n  box-sizing: border-box;\n  display: block;\n  transition: border-color 0.15s;\n}\n.about-trigger[_ngcontent-%COMP%]:hover {\n  border-color: var(--color-primary);\n}\n.about-popup--dev[_ngcontent-%COMP%] {\n  left: 0;\n  right: auto;\n}\n.about-popup--dev[_ngcontent-%COMP%]::after {\n  left: 10px;\n  right: auto;\n}\n.footer-right[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  margin-left: auto;\n}\n.signin-btn[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  background: transparent;\n  color: var(--color-primary);\n  border: 1.5px solid var(--color-primary);\n  border-radius: 10px;\n  padding: 8px 14px;\n  font-weight: 600;\n  font-size: 13px;\n  cursor: pointer;\n  white-space: nowrap;\n  transition: background 0.15s;\n}\n.signin-btn[_ngcontent-%COMP%]:hover {\n  background: #fffbeb;\n}\n.profile-wrap[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  cursor: pointer;\n  position: relative;\n  -webkit-user-select: none;\n  user-select: none;\n}\n.profile-wrap[_ngcontent-%COMP%]   .text[_ngcontent-%COMP%] {\n  text-align: right;\n}\n.profile-wrap[_ngcontent-%COMP%]   .text[_ngcontent-%COMP%]   .name[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 13px;\n  font-weight: 600;\n  color: #1a1a1a;\n  line-height: 1.3;\n}\n.profile-wrap[_ngcontent-%COMP%]   .text[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 10px;\n  color: #6b7280;\n  font-weight: 400;\n  white-space: nowrap;\n}\n.profile-wrap[_ngcontent-%COMP%]   .profile-picture[_ngcontent-%COMP%] {\n  border-radius: 10px;\n  border: 2px solid var(--color-primary);\n  box-sizing: border-box;\n  object-fit: cover;\n  flex-shrink: 0;\n}\n.profile-wrap--guest[_ngcontent-%COMP%] {\n  cursor: pointer;\n}\n.profile-wrap--guest[_ngcontent-%COMP%]   .name[_ngcontent-%COMP%] {\n  color: #6b7280;\n}\n.profile-wrap--guest[_ngcontent-%COMP%]   .profile-picture--guest[_ngcontent-%COMP%] {\n  width: 36px;\n  height: 36px;\n  border-radius: 10px;\n  border: 2px solid #e5e7eb;\n  box-sizing: border-box;\n  flex-shrink: 0;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: #f9fafb;\n  color: #9ca3af;\n}\n.saved-count[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  width: 100%;\n  padding: 10px 12px;\n  background: #f3f4f6;\n  border-radius: 10px;\n  font-size: 13px;\n  font-weight: 600;\n  color: #374151;\n  text-decoration: none;\n  transition: background 0.15s;\n}\n.saved-count[_ngcontent-%COMP%]:hover, \n.saved-count[_ngcontent-%COMP%]:active {\n  background: #e5e7eb;\n}\n.about-popup[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: calc(100% + 12px);\n  right: 0;\n  width: 240px;\n  background: #fff;\n  border-radius: 14px;\n  padding: 24px 20px 18px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  box-shadow: 0 8px 40px rgba(0, 0, 0, 0.14), 0 2px 8px rgba(0, 0, 0, 0.06);\n  border: 1px solid rgba(0, 0, 0, 0.07);\n  animation: _ngcontent-%COMP%_popUp 0.2s cubic-bezier(0.34, 1.56, 0.64, 1);\n  z-index: 100;\n}\n.about-popup[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  bottom: -6px;\n  right: 22px;\n  width: 12px;\n  height: 12px;\n  background: #fff;\n  border-right: 1px solid rgba(0, 0, 0, 0.07);\n  border-bottom: 1px solid rgba(0, 0, 0, 0.07);\n  transform: rotate(45deg);\n}\n@keyframes _ngcontent-%COMP%_popUp {\n  from {\n    opacity: 0;\n    transform: translateY(8px) scale(0.95);\n  }\n  to {\n    opacity: 1;\n    transform: translateY(0) scale(1);\n  }\n}\n.about-photo[_ngcontent-%COMP%] {\n  width: 72px;\n  height: 72px;\n  border-radius: 10px;\n  object-fit: cover;\n  object-position: center top;\n  border: 2px solid var(--color-primary);\n  box-shadow: 0 0 0 4px rgba(244, 169, 34, 0.1);\n  margin-bottom: 12px;\n}\n.user-photo[_ngcontent-%COMP%] {\n  border-radius: 50%;\n  object-position: center center;\n}\n.about-name[_ngcontent-%COMP%] {\n  font-size: 16px;\n  font-weight: 700;\n  color: #111827;\n  letter-spacing: -0.3px;\n}\n.about-email[_ngcontent-%COMP%] {\n  font-size: 11.5px;\n  color: #6b7280;\n  margin-top: 3px;\n  word-break: break-all;\n}\n.level-badge[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  background:\n    linear-gradient(\n      135deg,\n      var(--color-primary) 0%,\n      #e09a1a 100%);\n  color: #fff;\n  font-size: 11px;\n  font-weight: 700;\n  padding: 4px 12px;\n  border-radius: 20px;\n  letter-spacing: 0.04em;\n  margin-top: 8px;\n}\n.about-divider[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 1px;\n  background: #e5e7eb;\n  margin: 14px 0;\n}\n.about-policies[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  width: 100%;\n  margin-bottom: 10px;\n}\n.about-policies[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  display: block;\n  padding: 11px 16px;\n  background: #f3f4f6;\n  border-radius: 10px;\n  color: #111827;\n  text-decoration: none;\n  font-weight: 600;\n  font-size: 13px;\n  text-align: center;\n  transition: background 0.15s;\n}\n.about-policies[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover, \n.about-policies[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:active {\n  background: #e5e7eb;\n}\n.signout-btn[_ngcontent-%COMP%] {\n  display: block;\n  width: 100%;\n  padding: 11px 16px;\n  background: #f3f4f6;\n  border: none;\n  border-radius: 10px;\n  color: #111827;\n  font-weight: 600;\n  font-size: 13px;\n  text-align: center;\n  cursor: pointer;\n  transition: background 0.15s;\n}\n.signout-btn[_ngcontent-%COMP%]:hover, \n.signout-btn[_ngcontent-%COMP%]:active {\n  background: #e5e7eb;\n}\n.about-version[_ngcontent-%COMP%] {\n  margin-top: 12px;\n  font-size: 10px;\n  color: #9ca3af;\n  font-family: monospace;\n}\n@media (max-width: 900px) {\n  .footer-links[_ngcontent-%COMP%] {\n    display: none;\n  }\n}\n/*# sourceMappingURL=footer.component.css.map */'] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FooterComponent, { className: "FooterComponent", filePath: "src/app/components/footer/footer.component.ts", lineNumber: 16 });
})();
...
var Geometry = class extends Object_default {
  constructor() {
    ...
    this.simplifyTransformedInternal = memoizeOne((revision, squaredTolerance, transform2) => {
      if (!transform2) {
...
function get4(image, cacheKey, crossOrigin, imageState, color, pattern) {
  ...
  if (!iconImage) {
    iconImage = new IconImage(image, image instanceof HTMLImageElement ? image.src || void 0 : cacheKey, crossOrigin, imageState, color);
...
var RegularShape = class _RegularShape extends Image_default {
  ...
  getAnchor() {
    ...
    return [size[0] / 2 - displacement[0] / scale4[0], size[1] / 2 + displacement[1] / scale4[1]];
  }
  /**
...
var Icon = class _Icon extends Image_default {
  ...
  getAnchor() {
    ...
    const displacement = this.getDisplacement();
    const scale4 = this.getScaleArray();
    return [anchor[0] - displacement[0] / scale4[0], anchor[1] + displacement[1] / scale4[1]];
  }
  /**
...
var RenderFeature = class _RenderFeature {
  ...
  transform(projection) {
    ...
    if (pixelExtent && projectedExtent) {
      const scale4 = getHeight(projectedExtent) / getHeight(pixelExtent);
      compose(tmpTransform2, projectedExtent[0], projectedExtent[3], scale4, -scale4, 0, 0, 0);
...
var Layer = class extends Base_default {
  ...
  setMap(map2) {
    ...
    if (map2) {
      this.mapPrecomposeKey_ = listen(map2, EventType_default2.PRECOMPOSE, function(evt) {
        const renderEvent = (
...
function parseMatchArgs(encoded, context, parsedArgs, typeHint) {
  ...
  return [parse2(encoded[1], context, inputType), ...args, parse2(encoded[encoded.length - 1], context, outputType)];
}
...
function parseCaseArgs(encoded, context, parsedArgs, typeHint) {
  ...
  args[args.length - 1] = parse2(encoded[encoded.length - 1], context, outputType);
  return args;
}
...
var BaseVectorLayer = class extends Layer_default {
  ...
  renderDeclutter(frameState, layerState) {
    ...
    if (declutterGroup in frameState.declutter === false) {
      frameState.declutter[declutterGroup] = new import_rbush2.default(9);
    }
...
var Executor = class {
  ...
  createLabel(text, textKey, fillKey, strokeKey) {
    ...
    const pixelRatio = this.pixelRatio;
    const scale4 = [textState.scale[0] * pixelRatio, textState.scale[1] * pixelRatio];
  ...
  execute(context, scaledCanvasSize, transform2, viewRotation, snapToPixel, declutterTree) {
    ...
    this.execute_(context, scaledCanvasSize, transform2, this.instructions, snapToPixel, void 0, void 0, declutterTree);
  }
  /**
   * @param {CanvasRenderingContext2D} context Context.
   * @param {import("../../transform.js").Transform} transform Transform.
  ...
  executeHitDetection(context, transform2, viewRotation, featureCallback, hitExtent) {
    this.viewRotation_ = viewRotation;
    return this.execute_(context, [context.canvas.width, context.canvas.height], transform2, this.hitDetectionInstructions, true, featureCallback, hitExtent);
  }
};
    ...
    for (i = 0, ii = zs.length; i < ii; ++i) {
      ...
      for (j = 0, jj = builderTypes.length; j < jj; ++j) {
        ...
        if (replay !== void 0) {
          ...
          replay.execute(context, scaledCanvasSize, transform2, viewRotation, snapToPixel, declutterTree);
          if (requireClip) {
            context.restore();
          }
          if (zIndexContext) {
...
function renderFeature(replayGroup, feature, style, squaredTolerance, listener, transform2, declutter, index) {
  ...
  renderFeatureInternal(replayGroup, feature, style, squaredTolerance, transform2, declutter, index);
  return loading;
}
...
var CanvasVectorLayerRenderer = class extends Layer_default3 {
  ...
  renderWorlds(executorGroup, frameState, declutterable) {
    ...
    do {
      ...
      executorGroup.execute(context, [context.canvas.width, context.canvas.height], transform2, rotation, snapToPixel, declutterable === void 0 ? ALL : declutterable ? DECLUTTER : NON_DECLUTTER, declutterable ? declutter && frameState.declutter[declutter] : void 0);
  ...
  renderFrame(frameState, target) {
    ...
    const width = Math.round(getWidth(extent) / resolution * pixelRatio);
    const height = Math.round(getHeight(extent) / resolution * pixelRatio);
    compose(this.pixelTransform, frameState.size[0] / 2, frameState.size[1] / 2, 1 / pixelRatio, 1 / pixelRatio, 0, -width / 2, -height / 2);
  ...
  renderFeature(feature, squaredTolerance, styles, builderGroup, transform2, declutter, index) {
    ...
    if (Array.isArray(styles)) {
      for (let i = 0, ii = styles.length; i < ii; ++i) {
        loading = renderFeature(builderGroup, feature, styles[i], squaredTolerance, this.boundHandleStyleImageChange_, transform2, declutter, index) || loading;
      }
    } else {
      loading = renderFeature(builderGroup, feature, styles, squaredTolerance, this.boundHandleStyleImageChange_, transform2, declutter, index);
    }
    return loading;
  }
};
...
var CompositeMapRenderer = class extends Map_default {
  ...
  constructor(map2) {
    super(map2);
    this.fontChangeListenerKey_ = listen(checkedFonts, ObjectEventType_default.PROPERTYCHANGE, map2.redrawText.bind(map2));
...
function render(width, height, pixelRatio, sourceResolution, sourceExtent, targetResolution, targetExtent, triangulation, sources, gutter, renderEdges, interpolate, drawSingle, clipExtent) {
  const context = createCanvasContext2D(Math.round(pixelRatio * width), Math.round(pixelRatio * height), canvasPool2);
  if (!interpolate) {
    context.imageSmoothingEnabled = false;
  }
  if (sources.length === 0) {
  ...
  if (!drawSingle || sources.length !== 1 || gutter !== 0) {
    stitchContext = createCanvasContext2D(Math.round(getWidth(sourceDataExtent) * stitchScale), Math.round(getHeight(sourceDataExtent) * stitchScale), canvasPool2);
    if (!interpolate) {
  ...
  renderFrame(frameState, target) {
    ...
    for (let x = tileRange.minX; x <= tileRange.maxX; ++x) {
      for (let y = tileRange.minY; y <= tileRange.maxY; ++y) {
        ...
        const childTileRange = tileGrid.getTileCoordChildTileRange(tile.tileCoord, tmpTileRange, tmpExtent2);
        let covered = false;
        if (childTileRange) {
...
// src/app/components/map/map-functions.ts
var getCoordinatesfromLonLat = (lon, lat) => fromLonLat([lon, lat]);
var getCoordinatesfromPixel = (arr) => toLonLat(arr);
...
// src/app/shared/utils/route-drawing.ts
var PIN_W = 22;
var PIN_H = 32;
...
var ROUTE_COLORS = ["#F4A922", "#22c55e", "#a855f7", "#ef4444"];
function buildRouteFeatures(mapPoints, options = {}) {
  ...
  for (let i = 0; i < coords.length - 1; i++) {
    if (!options.skipSegmentColors && mapPoints[i]?.segmentColor)
      running = mapPoints[i].segmentColor;
  ...
  for (let i = 0; i < coords.length - 1; i++) {
    ...
    const isDashed = point?.lineStyle === "dashed" ? true : point?.lineStyle === "solid" ? false : options.dashed ?? false;
    const segOutline = new Feature_default(new LineString_default(segCoords));
    segOutline.setStyle(new Style_default({
      stroke: new Stroke_default({ color: "rgba(255,255,255,0.75)", width: 6 })
    }));
    const segLine = new Feature_default(new LineString_default(segCoords));
    segLine.setStyle(new Style_default({
      stroke: new Stroke_default({
        color: segColor,
        width: 3,
        lineDash: isDashed ? [12, 8] : void 0
      })
    }));
  ...
  coords.forEach((coord, i) => {
    ...
    if (isLast && options.skipEndPin)
      return;
    if (isFirst || isLast || mp?.showPin) {
      const label = isFirst ? mp?.label ?? "Parking" : isLast ? mp?.label ?? "Destination" : mp?.label ?? "";
      const pinColor = isFirst ? "#3b82f6" : isLast ? segColors[segColors.length - 1] : color;
      const zIdx = isLast ? 2 : 1;
      const iconFeature = new Feature_default(new Point_default(coord));
      iconFeature.setStyle(new Style_default({
        image: new Icon_default({
      ...
      const labelFeature = new Feature_default(new Point_default(coord));
      labelFeature.setStyle(new Style_default({
        text: new Text_default({
          text: label,
          font: "bold 11px sans-serif",
          fill: new Fill_default({ color: "#1a1a1a" }),
          stroke: new Stroke_default({ color: "#ffffff", width: 3 }),
          offsetX: 0,
          offsetY: -(PIN_H + 10),
          textAlign: "center",
          textBaseline: "middle",
      ...
      const dot = new Feature_default(new Point_default(coord));
      dot.setStyle(new Style_default({
        image: new Icon_default({
          img: (() => {
...
// src/app/shared/utils/location-tracker.ts
var LocationTracker = class {
  constructor(source, map2, options = {}) {
    this.lastCoord = null;
    this.following = false;
    this.unavailable = false;
    this.watchId = null;
    this.coneCanvas = null;
    this.firstFixFired = false;
    this.triedFallback = false;
    this.source = source;
    this.map = map2;
    this.opts = __spreadValues({ showHeadingCone: false, followZoom: 17 }, options);
  }
  get hasGps() {
    return this.lastCoord !== null;
  }
  start() {
  ...
  startWatch(highAccuracy) {
    this.watchId = navigator.geolocation.watchPosition((pos) => {
      ...
      maximumAge: highAccuracy ? 1e4 : 3e4,
      timeout: highAccuracy ? 8e3 : 15e3
    });
  }
  onPosition(pos) {
    this.unavailable = false;
  ...
  updateFeatures(coord, accuracy, heading) {
    let ring = this.source.getFeatureById("accuracy");
    const r = Math.min(accuracy ?? 50, 200);
    if (!ring) {
      ring = new Feature_default(new Circle_default(coord, r));
      ring.setId("accuracy");
      ring.setStyle(new Style_default({
        fill: new Fill_default({ color: "rgba(66,133,244,0.10)" }),
        stroke: new Stroke_default({ color: "rgba(66,133,244,0.30)", width: 1.5 })
      }));
      this.source.addFeature(ring);
    } else {
      ring.getGeometry().setCenterAndRadius(coord, r);
    }
    if (this.opts.showHeadingCone && heading != null && !isNaN(heading)) {
      const headingRad = heading * Math.PI / 180;
      let cone = this.source.getFeatureById("cone");
      if (!cone) {
        cone = new Feature_default(new Point_default(coord));
        cone.setId("cone");
        this.source.addFeature(cone);
      } else {
        cone.getGeometry().setCoordinates(coord);
      }
      cone.setStyle(new Style_default({
        image: new Icon_default({
    ...
    let dot = this.source.getFeatureById("gps");
    if (!dot) {
      dot = new Feature_default(new Point_default(coord));
      dot.setId("gps");
      dot.setStyle(new Style_default({
        image: new Circle_default2({
          radius: 9,
          fill: new Fill_default({ color: "#4285F4" }),
          stroke: new Stroke_default({ color: "#ffffff", width: 2.5 })
        }),
        zIndex: 200
      }));
      this.source.addFeature(dot);
    } else {
      dot.getGeometry().setCoordinates(coord);
    }
  }
  getConeCanvas() {
    if (this.coneCanvas)
      return this.coneCanvas;
    const size = 60;
    const canvas = document.createElement("canvas");
    canvas.width = size;
    canvas.height = size;
...
function MapComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "circle", 8)(3, "line", 9)(4, "line", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5, " Location access denied \u2014 enable it in your browser settings ");
    \u0275\u0275elementEnd();
  }
}
var ICON_CANVAS_SIZE = 80;
var ICON_TAIL_H = 18;
...
var MapComponent = class _MapComponent {
  constructor() {
    ...
    this.rawImageCache = /* @__PURE__ */ new Map();
    this.localityIconCache = /* @__PURE__ */ new Map();
    this.allFeatures = [];
    ...
    this.mapTapped = new EventEmitter();
    this.gpsCoord = new EventEmitter();
    this.providerPinSelected = new EventEmitter();
    this.controlTapped = new EventEmitter();
  ...
  set activeFilters(filters) {
    if (filters.length === 1 && filters[0] === "deals") {
      ...
      this.filteredFeatures = filters.length === 0 ? this.allFeatures : this.allFeatures.filter((f) => filters.some((flt) => matchesFilter(f.get("location"), flt)));
    }
  ...
  ngAfterViewInit() {
    if (!isPlatformBrowser(this.platformId))
      return;
    this.map = createMap(getCoordinatesfromLonLat(this.maltaCoordinates[0], this.maltaCoordinates[1]), 10.2, "ol-map");
    ...
    this.map.on("click", (evt) => {
      ...
      console.log(`\u{1F4CD} lat: ${lat}, lon: ${lon}`);
    ...
    if (this._selectedLocation)
      this.showLocation(this._selectedLocation);
  }
  ...
  // ── Cluster layer setup ───────────────────────────────────
  setupClusterLayer() {
    this.allFeatures = locations.map((location) => new Feature_default({
      geometry: new Point_default(getCoordinatesfromLonLat(location.lon, location.lat)),
      location
    }));
    this.filteredFeatures = [...this.allFeatures];
    this.clusterSource = new Vector_default();
    this.clusterLayer = new Vector_default2({
  ...
  buildLocalityFeatures() {
    const groups = /* @__PURE__ */ new Map();
    for (const f of this.filteredFeatures) {
      const key = f.get("location").locality ?? "Other";
      if (!groups.has(key))
        groups.set(key, []);
    ...
    for (const [locality, features] of groups) {
      ...
      const rep = features.find((f) => f.get("location").clusterPriority) ?? features.reduce((a, b) => b.get("location").id > a.get("location").id ? b : a);
      this.localityFeatures.push(new Feature_default({
        geometry: new Point_default([cx, cy]),
  ...
  featureStyle(feature) {
    return feature.get("type") === "locality-cluster" ? this.localityClusterStyle(feature) : this.individualPinStyle(feature);
  }
  individualPinStyle(feature) {
    const location = feature.get("location");
    const zoom = this.map.getView().getZoom() ?? 10;
    ...
    if (canvas) {
      ...
      return new Style_default({
        ...
        zIndex: -Math.round(coords[1] / 1e3)
      });
    }
    return new Style_default({
      image: new Circle_default2({
        radius: iconSize / 2,
        fill: new Fill_default({ color: "#d1d5db" }),
        stroke: new Stroke_default({ color: "white", width: 2 })
      })
    });
  }
  localityClusterStyle(feature) {
    ...
    const zoom = this.map.getView().getZoom() ?? 10;
    const scale4 = this.getLocalityScale(zoom);
    const circleCenter = 42;
    return new Style_default({
      image: new Icon_default({
        img: canvas,
        size: [canvas.width, canvas.height],
  ...
  buildLocalityCanvas(imgSrc, count, locality) {
    const R = 36;
    const CX = 50;
    const CY = 42;
    const W = 100;
    ...
    if (rawImg?.complete && rawImg.naturalWidth) {
      ...
      ctx.clip();
      const side = R * 2;
      const scale4 = Math.max(side / rawImg.naturalWidth, side / rawImg.naturalHeight);
      const sw = side / scale4;
      const sh = side / scale4;
  ...
  rebuildProviderLayer() {
    ...
    for (const p of this._providerPins) {
      if (!p.lat || !p.lon)
        continue;
      this.providerSource.addFeature(new Feature_default({
        geometry: new Point_default(getCoordinatesfromLonLat(p.lon, p.lat)),
        type: "provider-pin",
        provider: p
      }));
  ...
  buildProviderEmojiPin(provider) {
    ...
    pc.fillText(provider.emoji ?? "\u{1F3F7}\uFE0F", cx, cy + 1);
    return canvas;
  }
  ...
  buildPillPin(pin, label, large = false, bgColor) {
  ...
  // ── Route layer ───────────────────────────────────────────
  setupRouteLayer() {
    this.map.addLayer(new Vector_default2({ source: this.routeSource, zIndex: 50 }));
    this.map.addLayer(new Vector_default2({ source: this.routeLabelSource, zIndex: 51, declutter: true }));
  }
  drawRoute(location) {
    ...
    if (location.routes && location.routes.length >= 2) {
      ...
      if (this.hasRouteFeatures) {
        ...
        const pin = new Feature_default({ geometry: new Point_default(getCoordinatesfromLonLat(location.lon, location.lat)) });
        pin.setStyle(makePinStyle("#F4A922"));
        this.routeSource.addFeature(pin);
      }
    }
  }
  drawAllRoutesForLocation(location) {
    ...
    [...location.routes].reverse().forEach((route, reversedI) => {
      ...
      const sharedDest = i > 0 && !!thisLast && !!route0Last && thisLast.lon === route0Last.lon && thisLast.lat === route0Last.lat;
  ...
  setRoute(points) {
    ...
    if (this.hasRouteFeatures) {
      ...
      const pin = new Feature_default({
        geometry: new Point_default(getCoordinatesfromLonLat(this.currentLocation.lon, this.currentLocation.lat))
      });
      pin.setStyle(makePinStyle("#F4A922"));
      this.routeSource.addFeature(pin);
    }
  ...
  setupLocationLayer() {
    ...
    this.map.addLayer(new Vector_default2({ source, zIndex: 200 }));
  ...
  ngOnDestroy() {
    ...
    if (this.absoluteHandler)
      window.removeEventListener("deviceorientationabsolute", this.absoluteHandler, true);
  ...
  toggleCompass() {
    return __async(this, null, function* () {
      ...
      const iosRequest = DeviceOrientationEvent.requestPermission;
      if (typeof iosRequest === "function") {
        const state = yield iosRequest().catch(() => "denied");
        if (state !== "granted")
          return;
      }
  ...
  locateMe() {
    ...
    if (last) {
      ...
      navigator.geolocation.getCurrentPosition((pos) => {
        const coord = this.tracker?.lastCoord ?? fromLonLat([pos.coords.longitude, pos.coords.latitude]);
  ...
  fitGpsAndLocation(gpsCoord) {
    if (this.selectedLocation) {
      const locCoord = fromLonLat([this.selectedLocation.lon, this.selectedLocation.lat]);
  ...
  showLocationDenied() {
    ...
    this.locationDeniedTimer = setTimeout(() => {
      this.locationDenied = false;
    }, 4e3);
  }
  clickon(data) {
  ...
  // ── Helpers ───────────────────────────────────────────────
  getLocationMapCoordinates(location) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MapComponent, selectors: [["app-map"]], hostVars: 2, hostBindings: function MapComponent_HostBindings(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275element(4, "i", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, MapComponent_div_5_Template, 6, 0, "div", 5);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_1_0;
        \u0275\u0275advance();
        \u0275\u0275classProp("active", ctx.compassMode || ctx.isRotated);
        \u0275\u0275advance(2);
        \u0275\u0275classProp("has-gps", (tmp_1_0 = ctx.tracker == null ? null : ctx.tracker.hasGps) !== null && tmp_1_0 !== void 0 ? tmp_1_0 : false);
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", ctx.locationDenied);
      }
    }, dependencies: [NgIf], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n[_nghost-%COMP%]   .map-container[_ngcontent-%COMP%] {\n  display: flex;\n  flex: 1 1 auto;\n  position: relative;\n}\n.compass-btn[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 130px;\n  right: 10px;\n  width: 40px;\n  height: 40px;\n  background: #fff;\n  border: none;\n  outline: none;\n  -webkit-tap-highlight-color: transparent;\n  border-radius: 50%;\n  box-shadow: 0 2px 12px rgba(0, 0, 0, 0.15);\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  color: #555;\n  font-size: 18px;\n  z-index: 5;\n  transition: background 0.15s, color 0.15s;\n}\n.compass-btn[_ngcontent-%COMP%]:hover {\n  background: #f5f5f5;\n}\n.compass-btn.active[_ngcontent-%COMP%] {\n  color: #4285F4;\n}\n.locate-btn[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 80px;\n  right: 10px;\n  width: 40px;\n  height: 40px;\n  background: #fff;\n  border: none;\n  outline: none;\n  -webkit-tap-highlight-color: transparent;\n  border-radius: 50%;\n  box-shadow: 0 2px 12px rgba(0, 0, 0, 0.15);\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  color: #555;\n  font-size: 16px;\n  z-index: 5;\n  transition:\n    background 0.15s,\n    color 0.15s,\n    box-shadow 0.15s;\n}\n.locate-btn[_ngcontent-%COMP%]:hover {\n  background: #f5f5f5;\n  box-shadow: 0 4px 16px rgba(0, 0, 0, 0.18);\n}\n.locate-btn.has-gps[_ngcontent-%COMP%] {\n  color: #4285F4;\n}\n.location-toast[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 140px;\n  left: 50%;\n  transform: translateX(-50%);\n  background: rgba(17, 24, 39, 0.88);\n  color: #fff;\n  font-size: 12px;\n  font-weight: 500;\n  padding: 8px 14px;\n  border-radius: 10px;\n  display: flex;\n  align-items: center;\n  gap: 7px;\n  white-space: nowrap;\n  pointer-events: none;\n  z-index: 10;\n  -webkit-backdrop-filter: blur(4px);\n  backdrop-filter: blur(4px);\n}\n.marker-dot[_ngcontent-%COMP%] {\n  padding: 0;\n  border-radius: 50% !important;\n  background: #ffffff;\n  border: 1px solid var(--color-blue, #F4A922);\n  object-fit: cover;\n  opacity: 0.9;\n  filter: none;\n}\n.marker-dot[_ngcontent-%COMP%] {\n  content-visibility: auto;\n}\n.marker-image[_ngcontent-%COMP%] {\n  border-radius: 10px;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.35);\n}\n/*# sourceMappingURL=map.component.css.map */"] });
  }
};
(() => {
...
var _c0 = [[["", "slot-top", ""]], [["", "slot-bottom", ""]]];
var _c1 = ["[slot-top]", "[slot-bottom]"];
function NavInterstitialComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 12);
    \u0275\u0275element(2, "circle", 13)(3, "circle", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("r", 26);
    \u0275\u0275advance();
    \u0275\u0275styleProp("stroke-dasharray", ctx_r0.circumference)("stroke-dashoffset", ctx_r0.dashOffset);
    \u0275\u0275attribute("r", 26);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.seconds);
  }
}
function NavInterstitialComponent_p_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.seconds > 0 ? "Opening in " + ctx_r0.seconds + "s\u2026" : "Ready!", " ");
  }
}
var RADIUS3 = 26;
var CIRCUMFERENCE = 2 * Math.PI * RADIUS3;
var NavInterstitialComponent = class _NavInterstitialComponent {
  constructor() {
    this.duration = 7;
    this.buttonLabel = "Open website";
  ...
  ngOnInit() {
    ...
    if (!isPlatformBrowser(this.platformId) || this.duration === 0)
      return;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavInterstitialComponent, selectors: [["app-nav-interstitial"]], inputs: { url: "url", duration: "duration", buttonLabel: "buttonLabel", openNewTab: "openNewTab" }, outputs: { closed: "closed" }, ngContentSelectors: _c1, decls: 16, vars: 6, consts: [[1, "overlay", 3, "click"], [1, "card", 3, "click"], [1, "card-header"], ["aria-label", "Close", 1, "dismiss-btn", 3, "click"], [1, "slot-wrap"], ["class", "countdown-wrap", 4, "ngIf"], ["class", "countdown-label", 4, "ngIf"], [1, "open-btn", 3, "click", "disabled"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.5", "stroke-linecap", "round", "stroke-linejoin", "round"], ["x1", "7", "y1", "17", "x2", "17", "y2", "7"], ["points", "7 7 17 7 17 17"], [1, "countdown-wrap"], ["viewBox", "0 0 60 60", "width", "60", "height", "60", 1, "ring"], ["cx", "30", "cy", "30", 1, "ring-bg"], ["cx", "30", "cy", "30", 1, "ring-fill"], [1, "countdown-num"], [1, "countdown-label"]], template: function NavInterstitialComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275projectionDef(_c0);
        \u0275\u0275elementStart(0, "div", 0);
        ...
        \u0275\u0275projection(6);
        \u0275\u0275elementEnd();
        \u0275\u0275template(7, NavInterstitialComponent_div_7_Template, 6, 7, "div", 5)(8, NavInterstitialComponent_p_8_Template, 2, 1, "p", 6);
        \u0275\u0275elementStart(9, "div", 4);
        \u0275\u0275projection(10, 1);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(11, "button", 7);
        \u0275\u0275listener("click", function NavInterstitialComponent_Template_button_click_11_listener() {
          return ctx.open();
        });
        \u0275\u0275text(12);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(13, "svg", 8);
        \u0275\u0275element(14, "line", 9)(15, "polyline", 10);
        \u0275\u0275elementEnd()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(7);
        \u0275\u0275property("ngIf", ctx.duration > 0);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.duration > 0);
        \u0275\u0275advance(3);
...
var CouponReminderComponent = class _CouponReminderComponent {
  ...
  static {
    this.\u0275fac = function CouponReminderComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _CouponReminderComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CouponReminderComponent, selectors: [["app-coupon-reminder"]], inputs: { provider: "provider" }, decls: 15, vars: 10, consts: [[1, "coupon-reminder"], [1, "coupon-reminder__header"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 2, "flex-shrink", "0"], ["d", "M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"], ["x1", "7", "y1", "7", "x2", "7.01", "y2", "7"], [1, "coupon-reminder__prompt"], [1, "coupon-reminder__box", 3, "click"], [1, "coupon-code"], [1, "copy-hint"], ["width", "13", "height", "13", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 4, "ngIf"], ["width", "13", "height", "13", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"], ["x", "9", "y", "9", "width", "13", "height", "13", "rx", "2", "ry", "2"], ["d", "M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"]], template: function CouponReminderComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(2, "svg", 2);
        \u0275\u0275element(3, "path", 3)(4, "line", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275namespaceHTML();
        ...
        \u0275\u0275text(8, " Copy your code before booking \u2014 you'll need it at checkout. ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(9, "button", 6);
        \u0275\u0275listener("click", function CouponReminderComponent_Template_button_click_9_listener() {
          return ctx.copy();
        });
        ...
        \u0275\u0275template(13, CouponReminderComponent__svg_svg_13_Template, 3, 0, "svg", 9);
        \u0275\u0275text(14);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        ...
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate(ctx.provider.discount.label);
        \u0275\u0275advance(3);
        \u0275\u0275styleProp("border-color", ctx.accentColor);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(ctx.provider.discount.coupon);
        \u0275\u0275advance();
        \u0275\u0275classProp("copied", ctx.copied);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.copied);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", ctx.copied ? "\u2713 Copied!" : "Tap to copy", " ");
      }
    }, dependencies: [CommonModule, NgIf], styles: ['\n\n.coupon-reminder[_ngcontent-%COMP%] {\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n}\n.coupon-reminder__header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 7px;\n  font-size: 13px;\n  font-weight: 700;\n}\n.coupon-reminder__prompt[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 12px;\n  color: #6b7280;\n  line-height: 1.4;\n}\n.coupon-reminder__box[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  width: 100%;\n  background: #fff;\n  border: 1.5px dashed;\n  border-radius: 10px;\n  padding: 11px 14px;\n  cursor: pointer;\n  text-align: left;\n  transition: background 0.15s;\n}\n.coupon-reminder__box[_ngcontent-%COMP%]:active {\n  background: #f9fafb;\n}\n.coupon-code[_ngcontent-%COMP%] {\n  font-size: 18px;\n  font-weight: 800;\n  letter-spacing: 2.5px;\n  color: #1a1a1a;\n  font-family: "Courier New", monospace;\n}\n.copy-hint[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  font-size: 11.5px;\n  color: #9ca3af;\n  font-weight: 500;\n  white-space: nowrap;\n}\n.copy-hint.copied[_ngcontent-%COMP%] {\n  color: #22c55e;\n  font-weight: 600;\n}\n/*# sourceMappingURL=coupon-reminder.component.css.map */'] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CouponReminderComponent, { className: "CouponReminderComponent", filePath: "src/app/components/coupon-reminder/coupon-reminder.component.ts", lineNumber: 98 });
})();

// src/app/platform/map-shell/map-shell.component.ts
var _c02 = ["panelWrap"];
function MapShellComponent_app_nav_interstitial_0_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 21);
    \u0275\u0275element(1, "app-coupon-reminder", 22);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("provider", ctx_r2.bridge.interstitialProvider());
  }
}
function MapShellComponent_app_nav_interstitial_0_div_2_p_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.bridge.interstitialLabel(), " ");
  }
}
function MapShellComponent_app_nav_interstitial_0_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 21);
    \u0275\u0275template(1, MapShellComponent_app_nav_interstitial_0_div_2_p_1_Template, 2, 1, "p", 23);
    \u0275\u0275elementStart(2, "app-provider-card", 24);
    \u0275\u0275listener("selected", function MapShellComponent_app_nav_interstitial_0_div_2_Template_app_provider_card_selected_2_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onInterstitialProviderSelected($event));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.bridge.interstitialLabel());
    \u0275\u0275advance();
    \u0275\u0275property("provider", ctx_r2.bridge.interstitialProviders()[0]);
  }
}
function MapShellComponent_app_nav_interstitial_0_app_provider_card_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-provider-card", 26);
    \u0275\u0275listener("selected", function MapShellComponent_app_nav_interstitial_0_app_provider_card_3_Template_app_provider_card_selected_0_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onInterstitialProviderSelected($event));
    });
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("provider", ctx_r2.bridge.interstitialProviders()[1]);
  }
}
function MapShellComponent_app_nav_interstitial_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-nav-interstitial", 18);
    \u0275\u0275listener("closed", function MapShellComponent_app_nav_interstitial_0_Template_app_nav_interstitial_closed_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onInterstitialClosed());
    });
    \u0275\u0275template(1, MapShellComponent_app_nav_interstitial_0_div_1_Template, 2, 1, "div", 19)(2, MapShellComponent_app_nav_interstitial_0_div_2_Template, 3, 2, "div", 19)(3, MapShellComponent_app_nav_interstitial_0_app_provider_card_3_Template, 1, 1, "app-provider-card", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("url", ctx_r2.bridge.pendingNavUrl())("duration", ctx_r2.bridge.interstitialProvider() ? 0 : ctx_r2.bridge.navDuration())("buttonLabel", ctx_r2.bridge.interstitialProvider() ? "Book Now" : "Open Google Maps")("openNewTab", true);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.bridge.interstitialProvider());
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r2.bridge.interstitialProvider() && ctx_r2.bridge.interstitialProviders()[0]);
    \u0275\u0275advance();
...
function MapShellComponent_app_filter_bar_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-filter-bar", 27);
...
function MapShellComponent_button_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("floating-back-btn--accent", ctx_r2.bridge.floatingBackBtn().accent);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r2.bridge.floatingBackBtn().label, " ");
  }
}
function MapShellComponent_button_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 30);
    \u0275\u0275listener("click", function MapShellComponent_button_8_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("show-panel-btn--primary", ctx_r2.isDeals());
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx_r2.showPanelBtnIcon());
  }
}
function MapShellComponent_div_9_button_3_span_1_Template(rf, ctx) {
  if (rf & 1) {
...
function MapShellComponent_div_9_button_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 33);
    \u0275\u0275listener("click", function MapShellComponent_div_9_button_3_Template_button_click_0_listener() {
      const i_r11 = \u0275\u0275restoreView(_r10).index;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onSelectRoute(i_r11));
    });
    \u0275\u0275template(1, MapShellComponent_div_9_button_3_span_1_Template, 2, 1, "span", 35);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function MapShellComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 32)(1, "button", 33);
    \u0275\u0275listener("click", function MapShellComponent_div_9_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(2, " All ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, MapShellComponent_div_9_button_3_Template, 3, 6, "button", 34);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("active", ctx_r2.bridge.activeRouteIndex() === -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r2.routes());
  }
}
...
function MapShellComponent_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 38);
    \u0275\u0275listener("click", function MapShellComponent_div_12_Template_div_click_0_listener($event) {
      \u0275\u0275restoreView(_r13);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275element(1, "img", 39);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 41)(5, "span");
    \u0275\u0275text(6, "FPV Drone Pilot");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span");
    \u0275\u0275text(8, "Content Creator");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "span");
    \u0275\u0275text(10, "Software Developer");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MapShellComponent_div_12_Template_a_click_15_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(16, "About");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "a", 45);
    \u0275\u0275listener("click", function MapShellComponent_div_12_Template_a_click_17_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showDevAbout = false);
    });
    ...
    \u0275\u0275listener("click", function MapShellComponent_div_12_Template_a_click_19_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showDevAbout = false);
    });
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "a", 47);
    \u0275\u0275listener("click", function MapShellComponent_div_12_Template_a_click_21_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showDevAbout = false);
    });
    \u0275\u0275text(22, "Contact");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 48)(24, "a", 49);
    \u0275\u0275text(25, "creator@johnfabiomb.com");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div", 50)(27, "a", 51);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(28, "svg", 52);
    \u0275\u0275element(29, "path", 53);
    \u0275\u0275elementEnd();
    \u0275\u0275text(30, " @johnfabiomb ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(31, "a", 54);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(32, "svg", 52);
    \u0275\u0275element(33, "path", 55);
    \u0275\u0275elementEnd();
    \u0275\u0275text(34, " John Monta\xF1o ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(35, "a", 56);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(36, "svg", 52);
    \u0275\u0275element(37, "path", 57);
    \u0275\u0275elementEnd();
    \u0275\u0275text(38, " @johnfabiomb ");
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(39, "div", 58);
    \u0275\u0275text(40);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function MapShellComponent_button_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 59);
    \u0275\u0275listener("click", function MapShellComponent_button_17_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
...
var MapShellComponent = class _MapShellComponent {
  constructor() {
    ...
    this.hasMultipleRoutes = computed(() => this.routes().length >= 2);
    this.routeColors = ROUTE_COLORS;
    this.showPanelBtnIcon = computed(() => {
  ...
  onInterstitialProviderSelected(provider) {
    this.bridge.interstitialProviderSelected$.next(provider);
    this.bridge.clearInterstitial();
  }
  static {
    this.\u0275fac = function MapShellComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _MapShellComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MapShellComponent, selectors: [["app-map-shell"]], viewQuery: function MapShellComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c02, 5);
      ...
      if (rf & 1) {
        ...
        \u0275\u0275listener("locationSelected", function MapShellComponent_Template_app_map_locationSelected_5_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.bridge.locationSelected$.next($event));
        })("providerPinSelected", function MapShellComponent_Template_app_map_providerPinSelected_5_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.bridge.providerPinSelected$.next($event));
        })("mapTapped", function MapShellComponent_Template_app_map_mapTapped_5_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onMapTapped());
        })("controlTapped", function MapShellComponent_Template_app_map_controlTapped_5_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onControlTapped());
        })("gpsCoord", function MapShellComponent_Template_app_map_gpsCoord_5_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.bridge.gpsCoord$.next($event));
        });
        \u0275\u0275elementEnd();
        \u0275\u0275template(7, MapShellComponent_button_7_Template, 3, 3, "button", 8)(8, MapShellComponent_button_8_Template, 2, 3, "button", 9)(9, MapShellComponent_div_9_Template, 4, 3, "div", 10)(10, MapShellComponent_div_10_Template, 3, 0, "div", 11);
        \u0275\u0275elementStart(11, "div", 12);
        \u0275\u0275template(12, MapShellComponent_div_12_Template, 41, 1, "div", 13);
        \u0275\u0275elementStart(13, "button", 14);
        \u0275\u0275listener("click", function MapShellComponent_Template_button_click_13_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.toggleDevAbout($event));
        });
        \u0275\u0275element(14, "img", 15);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(15, "div", 16, 1);
        \u0275\u0275template(17, MapShellComponent_button_17_Template, 2, 0, "button", 17);
        \u0275\u0275element(18, "router-outlet");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(19, "app-footer");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
