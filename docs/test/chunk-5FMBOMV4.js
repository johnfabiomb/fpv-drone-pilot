...
var MapExploreComponent = class _MapExploreComponent {
  ...
  ngOnInit() {
    ...
    this.bridge.floatingBackBtnClicked$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MapExploreComponent, { className: "MapExploreComponent", filePath: "src/app/platform/map-explore/map-explore.component.ts", lineNumber: 18 });
})();
export {
  MapExploreComponent
};
//# sourceMappingURL=chunk-5FMBOMV4.js.map
