...
var StaffAdminComponent = class _StaffAdminComponent {
  ...
  removeStaff(s) {
    return __async(this, null, function* () {
      if (!confirm(`Remove worker "${s.name}"?`))
        return;
      try {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaffAdminComponent, { className: "StaffAdminComponent", filePath: "src/app/booking/platform/staff/staff-admin.component.ts", lineNumber: 17 });
})();
export {
  StaffAdminComponent
};
//# sourceMappingURL=chunk-JCE7MC55.js.map
