...
import {
  ...
  CdkMenuItem,
  CdkMenuTrigger
} from "./chunk-MP42IJA2.js";
import "./chunk-ZQXBBVHZ.js";
import {
  BookingDataService
...
function BookingListComponent_Conditional_36_For_3_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 30);
  }
}
function BookingListComponent_Conditional_36_For_3_For_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingListComponent_Conditional_36_For_3_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 32);
    \u0275\u0275listener("click", function BookingListComponent_Conditional_36_For_3_For_2_Template_button_click_0_listener() {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, BookingListComponent_Conditional_36_For_3_For_2_Conditional_3_Template, 2, 3, "span", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function BookingListComponent_Conditional_36_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, BookingListComponent_Conditional_36_For_3_Conditional_0_Template, 1, 0, "span", 30);
    \u0275\u0275repeaterCreate(1, BookingListComponent_Conditional_36_For_3_For_2_Template, 4, 4, "button", 31, _forTrack0);
  }
  if (rf & 2) {
    const group_r5 = ctx.$implicit;
    const \u0275$index_81_r6 = ctx.$index;
    \u0275\u0275conditional(\u0275$index_81_r6 > 0 ? 0 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(group_r5);
  }
}
...
function BookingListComponent_Conditional_36_Conditional_11_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r3.busyId() === b_r8.id ? "\u2026" : "Approve", " ");
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r3.busyId() === b_r8.id);
  }
}
function BookingListComponent_Conditional_36_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, BookingListComponent_Conditional_36_Conditional_11_For_2_Template, 15, 15, "div", 35, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
...
function BookingListComponent_Conditional_36_Conditional_12_For_21_Conditional_27_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, BookingListComponent_Conditional_36_Conditional_12_For_21_Conditional_27_ng_template_8_Conditional_3_Template, 2, 0, "button", 68);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, BookingListComponent_Conditional_36_Conditional_12_For_21_Conditional_27_ng_template_8_Conditional_6_Template, 2, 0, "button", 69);
...
function BookingListComponent_Conditional_36_Conditional_12_For_21_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(5, "circle", 63)(6, "circle", 64)(7, "circle", 65);
    \u0275\u0275elementEnd()()();
...
function BookingListComponent_Conditional_36_Conditional_12_For_21_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "circle", 63)(3, "circle", 64)(4, "circle", 65);
    \u0275\u0275elementEnd()();
...
function BookingListComponent_Conditional_36_Conditional_12_For_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "tr")(1, "td", 45)(2, "button", 46);
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, BookingListComponent_Conditional_36_Conditional_12_For_21_Conditional_4_Template, 2, 0, "span", 47);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td", 50)(10, "span", 51);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, BookingListComponent_Conditional_36_Conditional_12_For_21_Conditional_13_Template, 2, 2, "span", 52)(14, BookingListComponent_Conditional_36_Conditional_12_For_21_Conditional_14_Template, 2, 1, "span", 53);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "td");
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "td")(19, "div", 54)(20, "span", 55);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd();
    \u0275\u0275template(22, BookingListComponent_Conditional_36_Conditional_12_For_21_Conditional_22_Template, 4, 12, "span", 56);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "td")(24, "span", 57);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "td", 58);
...
function BookingListComponent_Conditional_36_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29)(1, "table", 43)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5, "Ref");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    \u0275\u0275text(7, "Job");
    ...
    \u0275\u0275repeaterCreate(20, BookingListComponent_Conditional_36_Conditional_12_For_21_Template, 29, 25, "tr", 44, _forTrack1);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
...
function BookingListComponent_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, BookingListComponent_Conditional_36_For_3_Template, 3, 1, null, null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "label", 22);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(5, "svg", 23);
    \u0275\u0275element(6, "circle", 24)(7, "path", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(9, BookingListComponent_Conditional_36_Conditional_9_Template, 2, 0, "div", 13)(10, BookingListComponent_Conditional_36_Conditional_10_Template, 2, 1, "div", 27)(11, BookingListComponent_Conditional_36_Conditional_11_Template, 3, 0, "div", 28)(12, BookingListComponent_Conditional_36_Conditional_12_Template, 22, 0, "div", 29);
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
...
function BookingListComponent_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "label", 72)(8, "input", 73);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 74)(12, "button", 75);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingListComponent, { className: "BookingListComponent", filePath: "src/app/booking/platform/bookings/booking-list/booking-list.component.ts", lineNumber: 44 });
})();
export {
  BookingListComponent
};
//# sourceMappingURL=chunk-2SHSHKRL.js.map
