...
} from "./chunk-KNYIR4BR.js";
import "./chunk-673NSJCU.js";
import {
  getIsland
} from "./chunk-WSUVHV4Q.js";
import {
  FEATURES
} from "./chunk-OKXXXTI4.js";
import {
  UserDataService
...
function LocationDetailComponent_ng_container_21_ng_container_2_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, LocationDetailComponent_ng_container_21_ng_container_2_div_1_ng_container_2_Template, 2, 1, "ng-container", 56);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, LocationDetailComponent_ng_container_21_ng_container_2_div_1_div_4_Template, 5, 2, "div", 57);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LocationDetailComponent_ng_container_21_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LocationDetailComponent_ng_container_21_ng_container_2_div_1_Template, 5, 3, "div", 50);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function LocationDetailComponent_ng_container_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LocationDetailComponent_ng_container_21_div_1_Template, 4, 0, "div", 48)(2, LocationDetailComponent_ng_container_21_ng_container_2_Template, 2, 1, "ng-container", 49)(3, LocationDetailComponent_ng_container_21_div_3_Template, 8, 1, "div", 50);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_ng_template_22_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, LocationDetailComponent_ng_template_22_div_0_div_1_Template, 4, 0, "div", 48);
    \u0275\u0275elementStart(2, "div", 55);
    \u0275\u0275text(3, "Google Maps directions");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, LocationDetailComponent_ng_template_22_div_0_div_4_Template, 5, 1, "div", 57);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function LocationDetailComponent_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, LocationDetailComponent_ng_template_22_div_0_Template, 5, 2, "div", 50);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_div_24_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, LocationDetailComponent_div_24_div_4_span_5_Template, 2, 1, "span", 68);
    \u0275\u0275elementEnd();
...
function LocationDetailComponent_div_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 60)(1, "h4", 61);
    \u0275\u0275text(2, "Closest Spots");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 62);
    \u0275\u0275template(4, LocationDetailComponent_div_24_div_4_Template, 10, 5, "div", 63);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LocationDetailComponent_div_25_a_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 76);
    \u0275\u0275element(1, "img", 77);
    \u0275\u0275elementStart(2, "div", 78)(3, "span", 79);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(12, _c0, g_r22.id));
    \u0275\u0275advance();
    \u0275\u0275property("src", g_r22.leaderPhoto || "/assets/images/default-avatar.svg", \u0275\u0275sanitizeUrl)("alt", g_r22.leaderName);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(g_r22.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind2(7, 9, g_r22.date.toDate(), "EEE d MMM"), " \xB7 ", g_r22.memberCount, " joining");
    \u0275\u0275advance(2);
    \u0275\u0275classMap("badge--" + g_r22.difficulty);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(g_r22.difficulty);
  }
}
function LocationDetailComponent_div_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 73)(1, "h4", 74)(2, "span");
    \u0275\u0275text(3, "\u{1F465}");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4, " Who's exploring here? ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, LocationDetailComponent_div_25_a_5_Template, 10, 14, "a", 75);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275property("ngForOf", ctx_r2.spotGroups());
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LocationDetailComponent, selectors: [["app-location-detail"]], inputs: { location: "location", userLat: "userLat", userLon: "userLon", activeRouteIndex: "activeRouteIndex" }, outputs: { close: "close", explore: "explore", navRequested: "navRequested", providerSelected: "providerSelected" }, features: [\u0275\u0275NgOnChangesFeature], decls: 26, vars: 18, consts: [["singleRouteNav", ""], ["class", "confirm-banner", 4, "ngIf"], ["class", "nearby-banner", 4, "ngIf"], ["class", "hiking-active", 4, "ngIf"], [1, "px-header"], ["class", "meta", 4, "ngIf"], [3, "src"], [1, "px-2"], [1, "description", 3, "innerHTML"], ["class", "nearby-experiences", 4, "ngIf"], [1, "actions"], [1, "actions-row"], [1, "button", 3, "click"], [1, "fa", "fa-map"], ["label", "Share", 3, "url", "shareTitle"], [1, "save-wrap"], [1, "save-btn", 3, "click", "title"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"], ["message", "Remove from saved?", "confirmLabel", "Remove", "cancelLabel", "Keep", 3, "danger", "confirmed", "cancelled", 4, "ngIf"], [1, "divider"], [4, "ngIf", "ngIfElse"], ["class", "closest-section", 4, "ngIf"], ["class", "exploring-section", 4, "ngIf"], [1, "confirm-banner"], [1, "confirm-text"], [1, "confirm-actions"], [1, "confirm-stay", 3, "click"], [1, "confirm-leave", 3, "click"], [1, "nearby-banner"], [1, "nearby-banner__text"], [1, "fa", "fa-map-marker"], [1, "nearby-banner__actions"], [1, "nearby-btn", "nearby-btn--stay", 3, "click"], [1, "nearby-btn", "nearby-btn--start", 3, "click"], [1, "hiking-active"], [1, "fa", "fa-street-view"], [1, "meta"], ["class", "tag", 4, "ngFor", "ngForOf"], ["class", "rating", 4, "ngIf"], [1, "tag"], [1, "rating"], [1, "fa", "fa-star"], [1, "nearby-experiences"], [1, "nearby-experiences__label"], [3, "provider", "selected", 4, "ngFor", "ngForOf"], [3, "selected", "provider"], ["message", "Remove from saved?", "confirmLabel", "Remove", "cancelLabel", "Keep", 3, "confirmed", "cancelled", "danger"], ["class", "route-alert", 4, "ngIf"], [4, "ngFor", "ngForOf", "ngForTrackBy"], ["class", "nav-section", 4, "ngIf"], [1, "route-alert"], ["width", "18", "height", "24", "viewBox", "0 0 24 30", "fill", "#EA4335", "xmlns", "http://www.w3.org/2000/svg", 2, "flex-shrink", "0"], ["d", "M12 0C7.58 0 4 3.58 4 8c0 5.5 8 22 8 22s8-16.5 8-22c0-4.42-3.58-8-8-8zm0 11c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z"], [1, "nav-section"], [1, "nav-section__label"], [4, "ngIf"], ["class", "button nav-btn", 3, "click", 4, "ngFor", "ngForOf"], [1, "button", "nav-btn", 3, "click"], [1, "nav-btn__hint"], [1, "closest-section"], [1, "closest-title"], [1, "closest-list"], ["class", "closest-card", 3, "click", 4, "ngFor", "ngForOf"], [1, "closest-card", 3, "click"], [1, "closest-thumb", 3, "src", "alt"], [1, "closest-info"], [1, "closest-name"], ["class", "closest-tag", 4, "ngIf"], [1, "closest-dist"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.5", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "closest-arrow"], ["points", "9 18 15 12 9 6"], [1, "closest-tag"], [1, "exploring-section"], [1, "exploring-title"], ["class", "exploring-card", 3, "routerLink", 4, "ngFor", "ngForOf"], [1, "exploring-card", 3, "routerLink"], ["width", "28", "height", "28", "referrerpolicy", "no-referrer", 1, "exploring-card__photo", 3, "src", "alt"], [1, "exploring-card__info"], [1, "exploring-card__title"], [1, "exploring-card__meta"], [1, "badge"]], template: function LocationDetailComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(24, LocationDetailComponent_div_24_Template, 5, 1, "div", 22)(25, LocationDetailComponent_div_25_Template, 6, 1, "div", 23);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_9_0;
        let tmp_14_0;
        const singleRouteNav_r23 = \u0275\u0275reference(23);
...
//# sourceMappingURL=chunk-MCNABOXZ.js.map
